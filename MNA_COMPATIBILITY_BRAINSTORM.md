...
8. **6c. Blood Tithe Modifier** — High-impact faction perk, moderate MnA API work
9. **5d. Harbinger Manaweaving Recipes** — JSON recipe definitions using MnA infrastructure
10. **6d. Spell → Manipulation Combos** — Event-driven, moderate complexity
