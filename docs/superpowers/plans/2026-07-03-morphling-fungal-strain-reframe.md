...
- The borrowed-blood reroute (Task 4 Step 2) and Last-Rite group (Task 4 Step 3) reference audit Phase-1 helpers that may not exist yet — local implementations with `TODO(audit)` markers are the intended interim, not blockers.
