...
The D2 catalogue **The Red Taxonomy** is part of the collapsed **Alchemical Fieldwork** group. Bringing distinct samples such as Infected Fungus, Stinkhorn Fungus, Sarcodes, Bleeding Heart, Rafflesia, Devil's Tooth, or Puffball Fungus to the Alchemist grants hidden specimen records; four distinct records complete `red_taxonomy_complete`. The first completion issues four Specimen Jars and four empty Blood Vials for continued field sampling. This catalogue is optional and does not gate rank.
