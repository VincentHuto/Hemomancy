...
- **Unlock economy:** Direct "unlock next summon with Sanguine Quintessence" spindle use is retired. The Veinwing Vulture, Marrow Spitter, and Gorebound Hulk Blood Crafting trials use Sanguine Quintessence; the Degree 5 Mnemonist Puppet trial uses **Mnemonic Ambergris**. Defeating the spawned unbound trial boss permanently grants that summon shape to the recorded trial caster.
...
| ![](../src/main/resources/assets/hemomancy/textures/item/sanguine_quintessence.png) Sanguine Quintessence | Rare Harbinger catalyst produced by the Exsanguination cardinal rite. Used as the Cardinal Focus medium for Founding Fane and as the held catalyst for the Veinwing Vulture, Marrow Spitter, and Gorebound Hulk puppeteer trials. |
...
| ![](../src/main/resources/assets/hemomancy/textures/item/mnemonic_ambergris.png) Mnemonic Ambergris | Nonlethal Mnemonic Whale sample/shed material; used as the held catalyst for the Mnemonist Puppet trial, as reef-memory ambience, as a Mnemonic Whispers brewing input, in Mnemonic Candle crafting, and in Ossuary Clock / Humoral Barometer recipes. |
...
| `puppeteer_trial_recipe` | `PuppeteerTrialRecipeSerializer` | In-world Blood Crafting pattern | Instant summon unlock trials. Uses Blood Structure-style pattern matching, a recipe-specific held catalyst, blood drain, pattern consumption, and an unbound hostile summon boss spawn. |
...
- `heldItem`: summon-specific held catalyst; the first three use `hemomancy:sanguine_quintessence`, while `mnemonist_puppet` uses `hemomancy:mnemonic_ambergris`
...
| `puppeteer_trial/mnemonist_puppet` | 5 | 1400 | Mnemonic Ambergris | Conscious Mass | Engram/Gilded Venous Stone frame, Conscious Mass field, Venous Stone center |
