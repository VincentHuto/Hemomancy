...
All four ordeals use `dominion_lesser`, no upper structure, no anchors or waves, and no fight timer. The caster lights the exact brazier offering signature, seats an owner-attuned Crossbar that controls no active bodies, and plants a Living Staff. After staff impact, the station is revalidated and the hostile is added before blood or offerings are committed. Spawn failure therefore consumes nothing. Once manifested, cancellation, caster loss, structure failure, Peaceful removal, or a missing tracked entity collapses the rite, removes the hostile, and grants nothing; committed blood and offerings are not refunded.
