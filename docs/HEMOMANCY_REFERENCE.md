...
Once learned, `conjure_staff` is a fixed utility alongside Blood Absorption and Blood Projection. It cannot be dememorized at the Reliquary, consumes no memorized slot, survives loadout changes, and remains selectable in the radial's utility section. Learning the Living Staff bond is still required. Staff conjuration omits the added pale pulse, red strands, and generic activation accent.
