...
> **2026-08-02 synchronization:** The primary lore and mechanics references have now been updated for D-001, D-005, D-006, D-009, D-010, and D-012, including the virtual Field Notes redesign that superseded this review's earlier stack-local notebook wording. This document remains the decision ledger; downstream books, dialogue, wiki pages, inquiries, and archival plans may still need their own synchronization passes.
...
| D-005 | Field Notes are variously described as dormant, physical, or ink-refilled content. | Use the implemented **virtual pending-memo queue** stored on the player. The Dictation Table transfers compatible pending memos into a placed Liber, spending blood for Liber Sanguinum or XP levels for Liber Immaculatus. Physical Field Notes and faction inks are retired/unregistered. | Primary mechanics reference synchronized 2026-08-02; books, NPC hints, wiki, and legacy strings remain downstream audit targets. |
...
| D-105 | Scars are described as ordinary worn items or inventory equipment. | Describe scars as burned into memory and managed through the Mason's Effigy / Iron Brazier loadout ritual. |
