...
| D-08 | **Wills lore canonization:** fold the two Will origins, the Blood Drunk Puppeteer retcon, and commandeering into `LORE_REFERENCE.md` as canon? | Wills plan Task 12 Step 3 | Decided 2026-07-11: Broken/Faded Wills are failed former Harbingers, Sent/Proctor Wills are purpose-built assessors, Blood Drunk Puppeteers are hive-pulled Broken Wills, and player Commandeer uses the owner-attuned Crossbar tether system. | DECIDED |
