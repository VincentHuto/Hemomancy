...
public class PacketCharmChange {
	public int player;
	public String where;
	public JsonElement slot;
	public ItemStack stack;

	public PacketCharmChange(LivingEntity player, String where, JsonElement slot, ItemStack stack) {
	...
	public PacketCharmChange(FriendlyByteBuf buf) {
