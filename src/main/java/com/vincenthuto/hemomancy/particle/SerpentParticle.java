...
@OnlyIn(Dist.CLIENT)
public class SerpentParticle extends TextureSheetParticle {
	...
	public SerpentParticle(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz, float r,
