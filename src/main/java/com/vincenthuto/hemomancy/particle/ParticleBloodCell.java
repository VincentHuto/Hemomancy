...
@OnlyIn(Dist.CLIENT)
public class ParticleBloodCell extends TextureSheetParticle {
	...
	public ParticleBloodCell(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz,
