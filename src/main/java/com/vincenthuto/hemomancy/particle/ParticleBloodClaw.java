...
public class ParticleBloodClaw extends TextureSheetParticle {
	...
	public ParticleBloodClaw(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz,
