...
public class QliphothBloomRenderer {
	...
	public static void renderTree(PoseStack stack, MultiBufferSource buffer, float time,
		...
		drawTrunk(coreVC, glowVC, mat, time, pulse, heightFrac);
		drawTrunkOrbs(coreVC, glowVC, mat, time, pulse, heightFrac);
		drawRoots(coreVC, glowVC, mat, time, pulse, rootFrac);
		if (branchFrac > 0f) {
			drawBranches(coreVC, glowVC, mat, time, pulse, branchFrac, stage >= 7);
		}
		if (stage >= 8) {
