...
import com.vincenthuto.hemomancy.common.tile.harbinger.functional.FungalPodiumBlockEntity;
...
public class FungalPodiumRenderer implements BlockEntityRenderer<FungalPodiumBlockEntity> {
	...
	public FungalPodiumRenderer(BlockEntityRendererProvider.Context p_173636_) {
	}
	...
	public void renderPlayer(FungalPodiumBlockEntity te, float partialTicks, PoseStack matrixStackIn,
			MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
