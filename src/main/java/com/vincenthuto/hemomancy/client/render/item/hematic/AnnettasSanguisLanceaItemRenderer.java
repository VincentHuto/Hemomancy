...
import com.vincenthuto.hemomancy.client.model.item.unstained.AnnettasSanguisLanceaModel;
import com.vincenthuto.hemomancy.common.init.RenderTypeInit;
import com.vincenthuto.hemomancy.common.item.unstained.tool.AnnettasSanguisLanceaItem;
...
public class AnnettasSanguisLanceaItemRenderer extends BlockEntityWithoutLevelRenderer {

	public static ResourceLocation texture = Hemomancy.rloc("textures/entity/sanguis_lancea/model_annettas_sanguis_lancea.png");

	public final AnnettasSanguisLanceaModel spearModel;
	private final AnnettasSanguisLanceaAnimContext animCtx = new AnnettasSanguisLanceaAnimContext(new AnimationState());

	public AnnettasSanguisLanceaItemRenderer(BlockEntityRenderDispatcher p_172550_, EntityModelSet p_172551_) {
		super(p_172550_, p_172551_);
		spearModel = new AnnettasSanguisLanceaModel(p_172551_.bakeLayer(AnnettasSanguisLanceaModel.LAYER_LOCATION));
		animCtx.state.start(0);

	}

	public AnnettasSanguisLanceaModel getModel() {
		return spearModel;
	}
	...
	public void renderByItem(ItemStack stack, ItemDisplayContext p_239207_2_, PoseStack ms, MultiBufferSource buffers,
		...
		if (stack.getItem() instanceof AnnettasSanguisLanceaItem) {
	...
	public record AnnettasSanguisLanceaAnimContext(AnimationState state) {
	}
