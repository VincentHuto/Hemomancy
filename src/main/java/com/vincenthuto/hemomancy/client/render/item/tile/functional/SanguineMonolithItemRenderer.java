...
public class SanguineMonolithItemRenderer extends BlockEntityWithoutLevelRenderer {
	...
	public SanguineMonolithItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
		...
		if (modelSet != null) {
			this.model = new SanguineMonolithModel(
					modelSet.bakeLayer(SanguineMonolithModel.LAYER_LOCATION));
		}
	}
