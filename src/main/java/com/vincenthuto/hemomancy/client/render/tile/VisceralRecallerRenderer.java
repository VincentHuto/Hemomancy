...
public class VisceralRecallerRenderer implements BlockEntityRenderer<VisceralRecallerBlockEntity> {
	...
	public VisceralRecallerRenderer(BlockEntityRendererProvider.Context ctx) {
	}

	@Override
	public boolean shouldRenderOffScreen(VisceralRecallerBlockEntity te) {
		return true;
	}
	...
	private void drawEnzymeIndicatorRings(PoseStack stack, MultiBufferSource bufferIn,
			VisceralRecallerBlockEntity te, Vec3 center, double diameter, float currentTime) {
		Map<EnumBloodTendency, Float> affs = te.getTendency();
	...
	private void drawBloodVolumeRing(PoseStack stack, MultiBufferSource bufferIn, VisceralRecallerBlockEntity te,
