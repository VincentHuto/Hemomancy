...
public class ChamberOfWillEffects extends DimensionSpecialEffects {
    ...
    private static void renderQliphothCommunionBackdrop(PoseStack poseStack, Tesselator tesselator, float time,
    ...
    private static void renderQliphothCommunionSky(PoseStack poseStack, Tesselator tesselator, float time,
                                                   float skyDistance, ChamberSkyTheme theme, int pomeCount) {
        if (!ChamberOfWillManager.THEME_QLIPHOTH_COMMUNION.equals(theme.id())) {
            return;
        }
    ...
    private static void renderQliphothSkyTendrils(PoseStack poseStack, Tesselator tesselator, float time,
    ...
    private static void renderQliphothSkyTendrilCluster(BufferBuilder buffer, Matrix4f matrix, float time,
    ...
    private static void emitQliphothSkyTendrilGeometry(BufferBuilder buffer, Matrix4f matrix,
    ...
    private static TendrilEffectConfig qliphothSkyTendrilConfig(long seed, boolean finalHole) {
    ...
    private static long qliphothSkyTendrilSeed(int hole, int tendril, boolean finalHole) {
    ...
    private static void renderQliphothConstellationSigils(PoseStack poseStack, Tesselator tesselator, float time,
                                                          float skyDistance, int pomeCount) {
        RenderSystem.setShader(GameRenderer::getPositionColorShader);
        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
        for (int face = 0; face < 6; face++) {
    ...
    private static void renderQliphothConstellationSigilFace(PoseStack poseStack, Tesselator tesselator, float time,
    ...
    private static void renderQliphothHookedBarSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
    ...
    private static void renderQliphothCrownedLoopSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                       float centerZ, float radius, float rotation,
                                                       float handedness, float depth, float width, int arcAlpha,
                                                       int shadowAlpha, int nodeAlpha, float skyDistance,
                                                       float time, int pomeCount, int face, Random random) {
    ...
    private static void renderQliphothForkedPendantSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                         float centerZ, float radius, float rotation,
    ...
    private static void renderQliphothLadderScrollSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                        float centerZ, float radius, float rotation,
                                                        float handedness, float depth, float width, int arcAlpha,
                                                        int shadowAlpha, int nodeAlpha, float skyDistance,
                                                        float time, int pomeCount, int face, Random random) {
    ...
    private static void renderQliphothCrescentHookSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                        float centerZ, float radius, float rotation,
                                                        float handedness, float depth, float width, int arcAlpha,
                                                        int shadowAlpha, int nodeAlpha, float skyDistance,
                                                        float time, int pomeCount, int face, Random random) {
    ...
    private static void renderQliphothTridentKnotSigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                       float centerZ, float radius, float rotation,
                                                       float handedness, float depth, float width, int arcAlpha,
                                                       int shadowAlpha, int nodeAlpha, float skyDistance,
                                                       float time, int pomeCount, int face, Random random) {
    ...
    private static void renderQliphothSteppedKeySigil(BufferBuilder buffer, Matrix4f matrix, float centerX,
                                                      float centerZ, float radius, float rotation,
                                                      float handedness, float depth, float width, int arcAlpha,
                                                      int shadowAlpha, int nodeAlpha, float skyDistance,
                                                      float time, int pomeCount, int face, Random random) {
    ...
    private static void addQliphothGoeticSealStroke(BufferBuilder buffer, Matrix4f matrix, float startX, float startZ,
    ...
    private static void addQliphothGoeticRuneBar(BufferBuilder buffer, Matrix4f matrix, float anchorX, float anchorZ,
    ...
    private static void addQliphothOrganicSigilCurve(BufferBuilder buffer, Matrix4f matrix, float[] start,
    ...
    private static void addQliphothOrganicSigilCurl(BufferBuilder buffer, Matrix4f matrix, float centerX,
    ...
    private static float[] qliphothOrganicSigilPoint(float centerX, float centerZ, float radius, float rotation,
    ...
    private static float[] qliphothSigilLensPull(float time, int pomeCount, float yaw, float pitch) {
        int smallHoleCount = Math.min(8, pomeCount);
        float yawPull = 0.0F;
    ...
    private static void addQliphothSigilNode(BufferBuilder buffer, Matrix4f matrix, float nodeX, float nodeZ,
    ...
    private static void renderQliphothRootScript(PoseStack poseStack, Tesselator tesselator, float time,
                                                 float skyDistance) {
        RenderSystem.setShader(GameRenderer::getPositionColorShader);
        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
        for (int face = 0; face < 6; face++) {
    ...
    private static void renderQliphothRootScriptFace(PoseStack poseStack, Tesselator tesselator, float time,
    ...
    private static void addQliphothRootStroke(BufferBuilder buffer, Matrix4f matrix, float startX, float startZ,
    ...
    private static void addQliphothStarGlyph(BufferBuilder buffer, Matrix4f matrix, float x, float z, float depth,
    ...
    private static void renderQliphothBlackHoles(PoseStack poseStack, float time, float skyDistance,
    ...
    private static void renderQliphothSmallBlackHole(PoseStack poseStack,
    ...
    private static void renderQliphothResidualRing(PoseStack poseStack,
                                                   MultiBufferSource.BufferSource bufferSource,
                                                   ChamberSkyTheme theme, float time, float skyDistance,
                                                   int hole, float[] direction, float[] migratedDirection) {
    ...
    private static void renderQliphothZenithBlackHole(PoseStack poseStack,
                                                      MultiBufferSource.BufferSource bufferSource,
                                                      ChamberSkyTheme theme, float time, float skyDistance) {
    ...
    private static void renderQliphothBlackHoleBillboard(PoseStack poseStack,
                                                         MultiBufferSource.BufferSource bufferSource,
    ...
    private static void renderQliphothZenithBlackHoleBillboard(PoseStack poseStack,
                                                               MultiBufferSource.BufferSource bufferSource,
                                                               ResourceLocation texture, float time, float skyDistance,
    ...
    private static void addQliphothBlackHoleBillboardVertex(Matrix4f matrix, VertexConsumer consumer, Vec3 position,
    ...
    private static void renderQliphothBlackHoleQuad(PoseStack poseStack, VertexConsumer consumer, float halfSize,
                                                    int alpha) {
        Matrix4f matrix = poseStack.last().pose();
