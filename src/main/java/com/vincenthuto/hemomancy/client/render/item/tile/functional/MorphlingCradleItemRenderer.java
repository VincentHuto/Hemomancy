...
public class MorphlingCradleItemRenderer extends BlockEntityWithoutLevelRenderer {
	public static final ResourceLocation TEXTURE = Hemomancy.rloc("textures/block/hematic_iron_block.png");
	private MorphlingCradleModel model;

	public MorphlingCradleItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
		super(dispatcher, modelSet);
		if (modelSet != null) {
			this.model = new MorphlingCradleModel(modelSet.bakeLayer(MorphlingCradleModel.LAYER_LOCATION));
		}
	}
