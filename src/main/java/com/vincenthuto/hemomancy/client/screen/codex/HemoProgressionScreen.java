...
public class HemoProgressionScreen extends AbstractProgressionCodexScreen {
	...
	public static void setupEntries() {
        ...
        ENTRIES.add(new BookEntry(
                "introduction", ItemInit.barbed_blade.get(), 0, 0)
        ...
        ENTRIES.add(new BookEntry(
                "spirit_crystals", 0, 1)
                .setObjectSupplier((s, e, x, y) -> new IconObject(s, e, Hemomancy.rloc("textures/gui/book/icons/soul_shard.png"), x, y))
        ...
        ENTRIES.add(new BookEntry(
                "natural_quartz", BlockInit.blood_crystal.get().asItem(), 3, 1)
...
////        ENTRIES.add(new BookEntry(
////                "soul_something", 3, 8)
////                .setObjectSupplier((e, x, y) -> new IconObject(e, Hemomancy.rloc("textures/gui/book/icons/soul_blade.png"), x, y))
////        );
//
//        ENTRIES.add(new BookEntry(
...
////        ENTRIES.add(new BookEntry(
////                "soul_ward", -3, 8)
////                .setObjectSupplier((e, x, y) -> new IconObject(e, Hemomancy.rloc("textures/gui/book/icons/soul_ward.png"), x, y))
////        );
//
//        ENTRIES.add(new BookEntry(
