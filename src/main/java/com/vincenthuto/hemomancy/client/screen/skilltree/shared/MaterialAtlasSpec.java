...
public final class MaterialAtlasSpec {
	...
	private static void registerBuckets() {
		...
		bucket(MaterialAtlasPath.HARBINGER, "fungal_ecology", "Fungal Ecology", 0xFF7EA33B, 850, 620, 1003, 490);
		bucket(MaterialAtlasPath.HARBINGER, "morphlings", "Morphlings", 0xFFB45BA5, 720, 820, 880, 1030);
		bucket(MaterialAtlasPath.HARBINGER, "scars_patterns", "Scars & Patterns", 0xFF6FC2D8, 520, 870, 152, 835);
		bucket(MaterialAtlasPath.HARBINGER, "living_implements", "Living Implements", 0xFFC58B35, 320, 780, 146, 602);
	...
	private static void registerHarbingerEntries() {
		...
		entryAt("aculeate_vitriol", h, "fungal_ecology", d(3), 983, 371, "toxicognath", "telson");
		entryAt("chromatic_sublimate", h, "fungal_ecology", d(3), 983, 408, "cuttlefish_chromatophores", "puppeteering_thread", "serpent_scale");
		entryAt("fervent_husk", h, "fungal_ecology", d(3), 1030, 336, "sclerotic_oleum");
		entryAt("queens_physogastrism", h, "fungal_ecology", d(3), 828, 336);
		entryAt("sclerotic_oleum", h, "fungal_ecology", d(3), 983, 336, "queens_physogastrism", "chitinous_husk");
		entryAt("telson", h, "fungal_ecology", d(3), 828, 371);
		entryAt("toxicognath", h, "fungal_ecology", d(3), 864, 371);
		...
		entryAt("bog_body", h, "fungal_ecology", d(2), 709, 445);
		...
		entryAt("chitinous_husk", h, "fungal_ecology", d(3), 864, 336);
		...
		entryAt("cuttlefish_chromatophores", h, "fungal_ecology", d(3), 828, 408);
		entryAt("erythrocytic_mycelium", h, "fungal_ecology", d(3), 800, 576, "erythrocytic_dirt");
		entryAt("fargone_proboscis", h, "fungal_ecology", d(3), 1030, 371, "aculeate_vitriol");
		entryAt("serpent_scale", h, "fungal_ecology", d(3), 911, 408);
		entryAt("spore_sac", h, "fungal_ecology", d(3), 757, 628, "erythrocytic_mycelium");
		entryAt("venous_pinion", h, "fungal_ecology", d(3), 709, 488);
		...
		entryAt("morphling_centipede", h, "morphlings", d(3), 1042, 968, "morphling_polyp");
		entryAt("morphling_chitinite", h, "morphlings", d(3), 1022, 913, "morphling_polyp");
		entryAt("morphling_cuttlefish", h, "morphlings", d(3), 975, 811, "morphling_polyp");
		...
		entryAt("morphling_mole", h, "morphlings", d(3), 1010, 859, "morphling_polyp");
		...
		entryAt("morphling_spider", h, "morphlings", d(3), 999, 995, "morphling_polyp");
		entryAt("morphling_tick", h, "morphlings", d(3), 863, 979, "morphling_polyp");
		entryAt("morphling_urchin", h, "morphlings", d(3), 951, 1019, "morphling_polyp");
		...
		entryAt("puppeteering_thread", h, "fungal_ecology", d(2), 864, 408);
