...
public final class MaterialAtlasSpec {
	...
	private static final int HARBINGER_HUB_LABEL_X = 630;
	private static final int HARBINGER_HUB_LABEL_Y = 577;
	...
	private static void registerBuckets() {
		bucket(MaterialAtlasPath.HARBINGER, "bloodcraft_core", "Bloodcraft Core", 0xFFD04436, 520, 230, 600, 250);
		bucket(MaterialAtlasPath.HARBINGER, "vascular_craft", "Vascular Craft", 0xFFB64044, 805, 330, 1090, 84);
		bucket(MaterialAtlasPath.HARBINGER, "alchemy_enzymes", "Alchemy & Enzymes", 0xFFD99B2D, 235, 330, 23, 108);
		bucket(MaterialAtlasPath.HARBINGER, "fungal_ecology", "Fungal Ecology", 0xFF7EA33B, 850, 620, 1395, 634);
		bucket(MaterialAtlasPath.HARBINGER, "morphlings", "Morphlings", 0xFFB45BA5, 720, 820, 1000, 1086);
		bucket(MaterialAtlasPath.HARBINGER, "scars_patterns", "Scars & Patterns", 0xFF6FC2D8, 520, 870, 488, 1243);
		bucket(MaterialAtlasPath.HARBINGER, "living_implements", "Living Implements", 0xFFC58B35, 320, 780, 146, 986);
		bucket(MaterialAtlasPath.HARBINGER, "architecture", "Architecture", 0xFF9A6A45, 180, 560, 242, 576);
	...
	private static void registerHarbingerEntries() {
		...
		entryAt("sanguine_formation", h, "bloodcraft_core", a(), 513, 484);
		entryAt("blood_crystal_shard", h, "bloodcraft_core", a(), 461, 424, "sanguine_formation");
		entryAt("blood_rock", h, "bloodcraft_core", a(), 339, 204);
		entryAt("blood_stained_stone", h, "bloodcraft_core", a(), 461, 484, "sanguine_formation");
		entryAt("hematic_iron_scrap", h, "bloodcraft_core", a(), 358, 615, "hematic_iron_ore");
		entryAt("hematic_iron_powder", h, "bloodcraft_core", d(2), 513, 424, "sanguine_formation");
		entryAt("vivianite_cluster", h, "bloodcraft_core", d(2), 413, 377, "blood_crystal_shard");
		entryAt("hematic_iron_block", h, "bloodcraft_core", d(2), 358, 556, "hematic_iron_ore");
		entryAt("hematic_iron_pillar", h, "bloodcraft_core", d(2), 295, 575, "hematic_iron_block");
		entryAt("sanguine_conduit", h, "bloodcraft_core", d(2), 568, 424, "sanguine_formation");
		entryAt("blood_crystal_block", h, "bloodcraft_core", d(3), 461, 377);
		entryAt("suspended_vivianite", h, "bloodcraft_core", d(3), 413, 323, "vivianite_cluster");
		entryAt("sanguine_quintessence", h, "bloodcraft_core", d(5), 568, 347, "sanguine_conduit");
		...
		entryAt("bloody_vial", h, "alchemy_enzymes", a(), 194, 347);
		entryAt("bloody_flask", h, "alchemy_enzymes", a(), 295, 143, "blood_rock");
		entry("bleeding_bulb", h, "alchemy_enzymes", a());
		entry("blood_chum", h, "alchemy_enzymes", a());
		entry("foul_paste", h, "alchemy_enzymes", a());
		entryAt("bloody_jug", h, "alchemy_enzymes", d(2), 247, 90, "bloody_flask");
		...
		entryAt("vial_centrifuge", h, "alchemy_enzymes", d(2), 193, 182);
		...
		entryAt("infected_fungus", h, "fungal_ecology", a(), 904, 615);
		...
		entryAt("venous_stone", h, "architecture", a(), 413, 507, "blood_stained_stone");
		entryAt("hematic_iron_ore", h, "architecture", a(), 413, 556);
		entryAt("polished_venous_stone", h, "architecture", d(2), 295, 461, "polished_venous_stone_bricks");
		entryAt("sanguine_glass", h, "architecture", d(2), 413, 461, "blood_crystal_shard");
		entryAt("vivianite_glass", h, "architecture", d(2), 364, 408, "sanguine_glass", "vivianite_cluster");
		entryAt("chiseled_hematic_iron_block", h, "architecture", d(3), 295, 541, "hematic_iron_block");
		entryAt("gilded_venous_stone", h, "architecture", d(3), 358, 461, "venous_stone");
		entryAt("polished_venous_stone_bricks", h, "architecture", d(3), 358, 507, "venous_stone");
	}
