...
public final class MaterialAtlasSpec {
	...
	private static void registerHarbingerEntries() {
		...
		entryAt("bloody_flask", h, "alchemy_enzymes", a(), 357, 480, "blood_rock", "ghastly_alembic");
		...
		entryAt("bloody_jug", h, "alchemy_enzymes", d(2), 357, 525, "bloody_flask");
		entryAt("vial_rack", h, "alchemy_enzymes", d(2), 760, 963, "bloody_vial");
		entryAt("blood_gourd_white", h, "alchemy_enzymes", d(2), 697, 484);
		entryAt("ghastly_alembic", h, "alchemy_enzymes", d(2), 357, 435);
		...
		entryAt("bog_body", h, "new_category", d(2), 649, 391);
		...
		entryAt("chitinous_husk", h, "new_category", d(3), 1000, 275);
		...
		entryAt("serpent_scale", h, "new_category", d(3), 1000, 345);
		...
		entryAt("chiseled_hematic_iron_block", h, "architecture", d(3), 477, 792, "hematic_iron_block");
		...
		entryAt("calcified_blood_spine", h, "new_category", d(1), 1000, 310);
		...
		entryAt("active_smouldering_ash", h, "alchemy_enzymes", d(3), 317, 391, "ghastly_alembic");
		entryAt("crimson_lacquer", h, "alchemy_enzymes", d(3), 317, 435, "ghastly_alembic");
		entryAt("engram_block", h, "alchemy_enzymes", d(3), 357, 391, "ghastly_alembic");
		...
		entryAt("sanguine_salve", h, "gourds_vessels", d(3), 360, 585, "bloody_jug");
		entryAt("scrying_dish", h, "gourds_vessels", d(3), 402, 525, "bloody_jug");
		entryAt("vascular_poultice", h, "gourds_vessels", d(3), 317, 585, "sanguine_salve");
		entryAt("vitality_chalice", h, "gourds_vessels", d(3), 317, 525, "bloody_jug");
		...
		entryAt("puppeteers_spindle", h, "vascular_craft", d(4), 1002, 385, "puppeteering_thread");
		...
		entryAt("calcified_erythrocoral", h, "myco_realm_blocks", d(4), 979, 585, "erythrocoral_block");
		entryAt("calcified_hyphae", h, "myco_realm_blocks", d(4), 1117, 594, "hyphae");
		entryAt("erythrocoral_block", h, "myco_realm_blocks", d(4), 939, 585);
		entryAt("erythrocoral_fan", h, "myco_realm_blocks", d(4), 979, 545, "erythrocoral_block");
		entryAt("erythrocoral_tendril", h, "myco_realm_blocks", d(4), 939, 545, "erythrocoral_block");
		...
		entryAt("constrictor_cord", h, "new_category", d(3), 1055, 385, "serpent_scale", "puppeteering_thread");
		entryAt("dried_leech", h, "new_category", d(3), 1105, 420);
		entryAt("erythrocoral_fragment", h, "new_category", d(3), 900, 585, "erythrocoral_block");
		entryAt("scale_grip", h, "new_category", d(3), 955, 310, "chitinous_husk", "serpent_scale");
		entryAt("swollen_leech", h, "new_category", d(3), 1105, 385);
		...
		entryAt("anastocordyceps_nexus", h, "spores_cultures", d(4), 1220, 858, "fungal_implantation_pylon");
		...
		entryAt("lumina_devorans", h, "spores_cultures", d(4), 1261, 858, "fungal_implantation_pylon");
		...
		entryAt("sanguiflora_cadens", h, "spores_cultures", d(4), 1341, 858, "fungal_implantation_pylon");
		...
		entryAt("thanomyces_resurgens", h, "spores_cultures", d(4), 1297, 903, "fungal_implantation_pylon");
