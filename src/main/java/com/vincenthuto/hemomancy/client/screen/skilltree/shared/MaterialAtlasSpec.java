...
public final class MaterialAtlasSpec {
	...
	private static final int HARBINGER_HUB_LABEL_Y = 601;
	...
	private static void registerHarbingerEntries() {
		...
		entryAt("bleeding_bulb", h, "fungal_ecology", a(), 940, 444, "bleeding_heart");
		...
		entryAt("bleeding_heart", h, "fungal_ecology", a(), 940, 484);
		...
		entryAt("erythrocoral_fragment", h, "new_category", d(3), 1000, 484, "erythrocoral_block");
