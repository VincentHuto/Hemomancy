...
/**
 * Renders a pulsing red glow border around active ScarButtons.
 ...
 */
public class ScarButtonGlowRenderer {
	...
	/**
	 * Renders the glow effect for both confirmed (red) and previewed (purple) scars.
	 *
	 * @param graphics        the GuiGraphics instance
	 * @param scarbuttonArray the 8x8 grid of chisel buttons
	 ...
	 */
	public static void renderGlowGrid(GuiGraphics graphics, ScarButton[][] scarbuttonArray, byte[][] pattern, byte[][] preview) {
		// Render purple glow for preview-only cells (previewed but not yet confirmed)
		renderGlowGridWithColor(graphics, scarbuttonArray, preview, pattern, PREVIEW_RED, PREVIEW_GREEN, PREVIEW_BLUE);
		// Render red glow for confirmed cells
		renderGlowGridWithColor(graphics, scarbuttonArray, pattern, null, RED, GREEN, BLUE);
	}
	 ...
	 */
	public static void renderGlowGrid(GuiGraphics graphics, ScarButton[][] scarbuttonArray, byte[][] pattern) {
		...
		for (int i = 0; i < 8; i++) {
			for (int j = 0; j < 8; j++) {
				if (pattern[i][j] != 0) {
					...
					ScarButton btn = scarbuttonArray[i][j];
	 ...
	 */
	private static void renderGlowGridWithColor(GuiGraphics graphics, ScarButton[][] scarbuttonArray,
