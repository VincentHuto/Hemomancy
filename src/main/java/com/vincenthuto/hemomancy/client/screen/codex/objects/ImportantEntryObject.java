 ...
 * com.vincenthuto.hemomancy.client.screen.codex.BookEntry;
 * 
 ...
 * 
 * public ImportantEntryObject(AbstractProgressionCodexScreen screen,
 * SkillTreeCodeModel model,String identifier,int chapter,String parentId,
 * ProgressionEntry entry, int posX, int posY) { super(screen, model,
 * identifier, chapter, parentId, entry, posX, posY); }
 * 
 ...
 * int posX = offsetPosX(xOffset); int posY = offsetPosY(yOffset);
 * HemoCodexHelper. renderTransparentTexture(HemoProgressionScreen.FADE_TEXTURE,
 * guiGraphics.pose(), posX - 13, posY - 13, 1, 252, 58, 58, 512, 512);
 * HemoCodexHelper. renderTexture(HemoProgressionScreen.FRAME_TEXTURE,
 * guiGraphics.pose(), posX, posY, 34, getFrameTextureV(), width, height, 512,
 * 512); HemoCodexHelper. renderTexture(HemoProgressionScreen.FRAME_TEXTURE,
 * guiGraphics.pose(), posX, posY, 133, getBackgroundTextureV(), width, height,
 * 512, 512); guiGraphics.renderItem(entry.getIconStack(), posX + 8, posY + 8);
 * } }
 */