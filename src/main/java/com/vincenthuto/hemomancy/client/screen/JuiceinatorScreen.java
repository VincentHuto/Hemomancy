...
/**
 * Juiceinator screen — fully programmatic, no texture files.
...
public class JuiceinatorScreen extends AbstractContainerScreen<JuiceinatorMenu> {
	...
	public JuiceinatorScreen(JuiceinatorMenu menu, Inventory inv, Component title) {
