...
public class EntryObject extends BookObject {
	...
	public void render(Minecraft minecraft, GuiGraphics guiGraphics, float xOffset, float yOffset, int mouseX,
		...
		ArcanaCodexHelper.renderTransparentTexture(ArcanaProgressionScreen.FADE_TEXTURE, guiGraphics.pose(), posX - 13,
				posY - 13, 1, 252, 58, 58, 512, 512);
		ArcanaCodexHelper.renderTexture(ArcanaProgressionScreen.FRAME_TEXTURE, guiGraphics.pose(), posX, posY, 1,
				getFrameTextureV(), width, height, 512, 512);
		ArcanaCodexHelper.renderTexture(ArcanaProgressionScreen.FRAME_TEXTURE, guiGraphics.pose(), posX, posY, 100,
