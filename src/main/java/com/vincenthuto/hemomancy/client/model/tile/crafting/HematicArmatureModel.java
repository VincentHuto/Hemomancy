...
public class HematicArmatureModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition platform = partdefinition.addOrReplaceChild("platform", CubeListBuilder.create().texOffs(0, 0).addBox(-22.0F, -2.0F, -22.0F, 44.0F, 2.0F, 44.0F, new CubeDeformation(0.0F))
				...
				.texOffs(92, 142).addBox(-5.0F, -8.0F, -5.0F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(127, 183).addBox(14.0F, -8.0F, -14.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(87, 192).addBox(16.0F, -5.0F, 12.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(39, 186).addBox(-16.0F, -8.0F, -14.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(192, 93).addBox(-18.0F, -5.0F, 12.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(192, 84).addBox(7.0F, -6.0F, -17.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(96, 192).addBox(-9.0F, -4.0F, -17.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition apex = partdefinition.addOrReplaceChild("apex", CubeListBuilder.create().texOffs(51, 142).addBox(-6.0F, -2.0F, -4.0F, 12.0F, 12.0F, 8.0F, new CubeDeformation(0.0F))
		...
		PartDefinition banners = partdefinition.addOrReplaceChild("banners", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int packedColor) {
		...
		apex.render(poseStack, vertexConsumer, packedLight, packedOverlay, packedColor);
		...
		banners.render(poseStack, vertexConsumer, packedLight, packedOverlay, packedColor);
