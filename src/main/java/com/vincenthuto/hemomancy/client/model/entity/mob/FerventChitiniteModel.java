...
public class FerventChitiniteModel extends HierarchicalModel<FerventChitiniteEntity> {
	...
	public static LayerDefinition createCrystalLayer() {
		...
		PartDefinition backSegment = whole.addOrReplaceChild("backSegment", CubeListBuilder.create().texOffs(21, 12).addBox(-2.5F, 0.849F, -0.3726F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition lLeg5 = backSegment.addOrReplaceChild("lLeg5", CubeListBuilder.create().texOffs(2, 12).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition lLeg4 = backSegment.addOrReplaceChild("lLeg4", CubeListBuilder.create().texOffs(16, 14).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition crystalBack = backSegment.addOrReplaceChild("crystalBack", CubeListBuilder.create().texOffs(30, 47).addBox(-3.5F, -3.0683F, -1.112F, 7.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(50, 48).addBox(-2.5F, -3.9683F, -0.612F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.6451F, 1.0903F));

		PartDefinition rLeg = backSegment.addOrReplaceChild("rLeg", CubeListBuilder.create().texOffs(0, 12).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rLeg4 = backSegment.addOrReplaceChild("rLeg4", CubeListBuilder.create().texOffs(2, 2).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition middleSegment = whole.addOrReplaceChild("middleSegment", CubeListBuilder.create().texOffs(0, 15).addBox(-3.0F, -1.6226F, -1.9775F, 6.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition crystalMiddle = middleSegment.addOrReplaceChild("crystalMiddle", CubeListBuilder.create().texOffs(9, 44).addBox(-3.0F, -4.3F, -1.5F, 6.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(10, 52).addBox(-2.0F, -5.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition lLeg3 = middleSegment.addOrReplaceChild("lLeg3", CubeListBuilder.create().texOffs(0, 17).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rLeg3 = middleSegment.addOrReplaceChild("rLeg3", CubeListBuilder.create().texOffs(0, 7).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition frontSegment = whole.addOrReplaceChild("frontSegment", CubeListBuilder.create().texOffs(0, 10).addBox(-4.0F, -0.5197F, -3.1395F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition lLeg2 = frontSegment.addOrReplaceChild("lLeg2", CubeListBuilder.create().texOffs(2, 17).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition lLeg = frontSegment.addOrReplaceChild("lLeg", CubeListBuilder.create().texOffs(18, 14).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition crystalFront = frontSegment.addOrReplaceChild("crystalFront", CubeListBuilder.create().texOffs(29, 54).addBox(-3.0F, -2.1F, 1.0F, 6.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(48, 55).addBox(-2.0F, -3.0F, 1.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.4803F, -3.1395F));

		PartDefinition rLeg2 = frontSegment.addOrReplaceChild("rLeg2", CubeListBuilder.create().texOffs(2, 7).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rLeg5 = frontSegment.addOrReplaceChild("rLeg5", CubeListBuilder.create().texOffs(0, 2).addBox(0.625F, 1.25F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition tail = whole.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, -0.1149F, -0.0043F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition head = whole.addOrReplaceChild("head", CubeListBuilder.create().texOffs(20, 6).addBox(-2.5F, -0.7866F, -2.7514F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition eyes = head.addOrReplaceChild("eyes", CubeListBuilder.create().texOffs(18, 24).addBox(-2.5F, -0.2667F, -1.8333F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 0.2301F, -0.668F));

		PartDefinition leftEye = eyes.addOrReplaceChild("leftEye", CubeListBuilder.create().texOffs(10, 26).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.75F, 0.0333F, -1.0833F));

		PartDefinition rightEye = eyes.addOrReplaceChild("rightEye", CubeListBuilder.create().texOffs(11, 22).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.75F, 0.0333F, -1.0833F));
