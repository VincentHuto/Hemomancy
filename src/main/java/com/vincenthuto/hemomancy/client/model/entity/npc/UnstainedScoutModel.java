 ...
 */
public class UnstainedScoutModel<T extends UnstainedScoutEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition canister = mask.addOrReplaceChild("canister", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.5F, -2.0F, 3.15F, 0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition body = whole.addOrReplaceChild("body", CubeListBuilder.create().texOffs(33, 15).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(42, 71).addBox(3.3498F, 0.3135F, -2.3F, 1.0F, 12.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 66).addBox(-4.2998F, 0.3135F, -2.3F, 1.0F, 12.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition SideclothR2 = SideclothR1.addOrReplaceChild("SideclothR2", CubeListBuilder.create().texOffs(78, 9).addBox(-0.7441F, -1.3998F, -2.5F, 1.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.9076F, 5.4763F, 0.0F));
        ...
        PartDefinition ClothBackR1 = ClothBack1.addOrReplaceChild("ClothBackR1", CubeListBuilder.create().texOffs(26, 82).addBox(-4.0F, 0.0F, -2.0F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1047F, 0.0F, 0.0F));
        ...
        PartDefinition rightArm = whole.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(72, 77).addBox(-3.25F, -1.5F, -2.5F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, 0.0F, 0.0F, 0.0F));
    ...
    @Override
    public void setupAnim(UnstainedScoutEntity   entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
