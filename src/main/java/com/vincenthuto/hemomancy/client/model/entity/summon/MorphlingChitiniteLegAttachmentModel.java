    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("thigh_plate",
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-5.2f, 1.0f, -2.4f, 3.0f, 5.0f, 4.8f, new CubeDeformation(0.08f))
                        .texOffs(18, 0)
                        .addBox(-6.2f, 2.0f, -1.4f, 1.2f, 3.0f, 2.8f, CubeDeformation.NONE),
                PartPose.ZERO);

        root.addOrReplaceChild("shin_plate",
                CubeListBuilder.create()
                        .texOffs(0, 14)
                        .addBox(-5.0f, 6.0f, -2.0f, 2.6f, 5.4f, 4.0f, new CubeDeformation(0.08f))
                        .texOffs(18, 14)
                        .addBox(-6.1f, 7.2f, -1.0f, 1.2f, 3.8f, 2.0f, CubeDeformation.NONE),
                PartPose.ZERO);

        root.addOrReplaceChild("spurs",
                CubeListBuilder.create()
                        .texOffs(34, 0)
                        .addBox(-6.6f, 3.0f, -0.5f, 2.6f, 0.8f, 1.0f, CubeDeformation.NONE)
                        .texOffs(34, 5)
                        .addBox(-6.4f, 8.3f, -0.5f, 2.2f, 0.8f, 1.0f, CubeDeformation.NONE)
                        .texOffs(34, 10)
                        .addBox(-4.4f, 10.8f, -2.8f, 1.4f, 0.8f, 1.6f, CubeDeformation.NONE),
                PartPose.ZERO);
