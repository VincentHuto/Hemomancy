...
public class OpenCurvedHornModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		// TODO: Replace with actual open curved horn model geometry
		...
		PartDefinition horn2 = horn.addOrReplaceChild("horn2",
				CubeListBuilder.create().texOffs(1, 25)
						.addBox(-2.0F, -3.625F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.5F)).texOffs(9, 4)
	...
	public OpenCurvedHornModel(ModelPart root) {
