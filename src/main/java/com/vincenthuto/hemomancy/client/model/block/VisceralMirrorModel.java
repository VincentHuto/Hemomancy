...
public class VisceralMirrorModel extends Model {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition base = partdefinition.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 40).addBox(-7.0F, -2.0F, 6.0F, 14.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(25, 0).addBox(-1.0F, -3.0F, -6.0F, 2.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(31, 40).addBox(-7.0F, -2.0F, -7.0F, 14.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition frame = partdefinition.addOrReplaceChild("frame", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -27.5F, -5.5F, 1.0F, 23.0F, 11.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(5, 44).addBox(-1.5F, -26.5F, -5.5F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition support = partdefinition.addOrReplaceChild("support", CubeListBuilder.create().texOffs(10, 44).addBox(-1.0F, -15.0F, 6.0F, 2.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(35, 44).addBox(-1.5F, -20.0F, -7.5F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 44).addBox(-1.5F, -20.0F, 5.5F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(17, 44).addBox(-1.0F, -15.0F, -7.0F, 2.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
