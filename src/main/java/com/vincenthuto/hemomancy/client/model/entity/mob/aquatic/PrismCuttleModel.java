...
public class PrismCuttleModel extends HierarchicalModel<PrismCuttleEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mantle = root.addOrReplaceChild("mantle", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.0F, -4.0F, 8.0F, 6.0F, 10.0F, new CubeDeformation(0.1F))
				.texOffs(22, 0).addBox(-4.0F, -2.0F, -8.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition left_fin = mantle.addOrReplaceChild("left_fin", CubeListBuilder.create().texOffs(28, 17).addBox(0.0F, -0.25F, -3.0F, 0.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.25F, -0.8F, 0.0F, 0.0F, 0.0F, 0.12F));

		PartDefinition right_fin = mantle.addOrReplaceChild("right_fin", CubeListBuilder.create().texOffs(40, 17).addBox(0.0F, -0.25F, -3.0F, 0.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.25F, -0.8F, 0.0F, 0.0F, 0.0F, -0.12F));

		for (int i = 0; i < 8; i++) {
			float x = -2.8F + i * 0.8F;
					root.addOrReplaceChild("arm_" + i, CubeListBuilder.create()
							.texOffs(0, 28).addBox(-0.25F, -0.25F, -0.5F, 0.5F, 0.5F, 7.0F,
