...
public class GhastlyAlembicModel extends Model {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base = GhastlyAlembic.addOrReplaceChild("Base", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -2.0F, -8.0F, 16.0F, 2.0F, 16.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(71, 46).addBox(-1.0F, -4.0F, 6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition ThornCollar = GhastlyAlembic.addOrReplaceChild("ThornCollar", CubeListBuilder.create().texOffs(34, 62).addBox(-6.0F, 1.0F, 5.0F, 12.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(48, 48).addBox(-6.0F, -6.0F, -5.0F, 1.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(25, 48).addBox(5.0F, -6.0F, -5.0F, 1.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition PipeRod = GhastlyAlembic.addOrReplaceChild("PipeRod", CubeListBuilder.create().texOffs(25, 62).addBox(-1.0F, -26.0F, -1.0F, 2.0F, 24.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 71).addBox(1.0F, -17.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(9, 71).addBox(1.0F, -10.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(66, 34).addBox(1.0F, -26.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.0F, 0.0F, 0.0F));
