...
public class PallidRetortModel extends Model {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            Hemomancy.rloc("pallid_retort_model"), "main");
    private final ModelPart PallidRetort;
    ...
    public PallidRetortModel(ModelPart root) {
        super(RenderType::entityTranslucent);
        this.PallidRetort = root.getChild("PallidRetort");
        this.Base = this.PallidRetort.getChild("Base");
        this.Flask = this.PallidRetort.getChild("Flask");
        this.ThornCollar = this.PallidRetort.getChild("ThornCollar");
        this.Cap = this.PallidRetort.getChild("Cap");
        this.PipeRod = this.PallidRetort.getChild("PipeRod");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition PallidRetort = partdefinition.addOrReplaceChild("PallidRetort", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition Base = PallidRetort.addOrReplaceChild("Base", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -2.0F, -8.0F, 16.0F, 2.0F, 16.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Flask = PallidRetort.addOrReplaceChild("Flask", CubeListBuilder.create().texOffs(0, 19).addBox(-5.0F, -8.0F, -5.0F, 10.0F, 16.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, 0.0F));

        PartDefinition ThornCollar = PallidRetort.addOrReplaceChild("ThornCollar", CubeListBuilder.create().texOffs(34, 62).addBox(-6.0F, 1.0F, 5.0F, 12.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Cap = PallidRetort.addOrReplaceChild("Cap", CubeListBuilder.create().texOffs(65, 10).addBox(-2.0F, 2.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition PipeRod = PallidRetort.addOrReplaceChild("PipeRod", CubeListBuilder.create().texOffs(25, 46).addBox(-1.0F, -28.0F, -1.0F, 2.0F, 26.0F, 2.0F, new CubeDeformation(0.0F))
