...
public class OpenBloodGourdModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		// TODO: Replace with actual open gourd model geometry
		PartDefinition gourd = body.addOrReplaceChild("gourd",
				CubeListBuilder.create().texOffs(0, 12)
						...
						.addBox(-1.5F, -0.6722F, -2.1F, 3.0F, 4.0F, 1.0F, new CubeDeformation(-0.375F)).texOffs(9, 4)
	...
	public OpenBloodGourdModel(ModelPart root) {
