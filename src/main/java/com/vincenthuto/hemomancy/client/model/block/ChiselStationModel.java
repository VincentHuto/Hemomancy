...
public class ChiselStationModel extends Model {
    ...
    public ChiselStationModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ToolRack = ChiselStation.addOrReplaceChild("ToolRack", CubeListBuilder.create().texOffs(49, 67).addBox(-8.0F, -5.0F, -9.0F, 16.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 83).addBox(4.0F, -12.0F, -9.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 85).addBox(2.0F, -10.0F, -9.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Shelf = ChiselStation.addOrReplaceChild("Shelf", CubeListBuilder.create().texOffs(49, 49).addBox(-11.0F, -22.0F, -10.0F, 22.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(69, 72).addBox(7.0F, -28.0F, -10.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 75).addBox(-10.0F, -28.0F, -10.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(50, 72).addBox(-3.0F, -29.0F, -10.0F, 6.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(78, 82).addBox(5.0F, -25.0F, -10.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(13, 83).addBox(-7.0F, -25.0F, -10.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
