...
public class SheolicBloodLustArmorModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createHeadLayer(EquipmentSlot slot) {
		...
		PartDefinition cube_r2 = headscutes.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.0F, -3.0F, 11.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -0.75F, -1.0F, -0.3054F, 0.0F, 0.0F));
		}
	...
	public static LayerDefinition createBodyLayer(EquipmentSlot slot) {
		...
		.texOffs(33, 99).addBox(1.75F, -5.2F, 1.2F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 2.0F));
		...
		.texOffs(22, 97).addBox(-1.3F, 2.0F, -2.6F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 0.0F));
		...
		.texOffs(98, 44).addBox(-1.7F, 2.0F, -2.6F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 0.0F));
		...
		PartDefinition r_shin_front_shell = right_leg.addOrReplaceChild("r_shin_front_shell", CubeListBuilder.create().texOffs(89, 91).addBox(-1.6F, -2.1F, -0.9F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, 8.6F, -1.8F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition r_heel_spur = r_boot_shell.addOrReplaceChild("r_heel_spur", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition l_shin_shell = left_leg.addOrReplaceChild("l_shin_shell", CubeListBuilder.create().texOffs(90, 54).addBox(0.8F, -1.2F, -1.95F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition l_shin_front_shell = left_leg.addOrReplaceChild("l_shin_front_shell", CubeListBuilder.create().texOffs(93, 25).addBox(-1.4F, -2.1F, -0.9F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, 8.6F, -1.8F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition l_heel_spur = l_boot_shell.addOrReplaceChild("l_heel_spur", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
