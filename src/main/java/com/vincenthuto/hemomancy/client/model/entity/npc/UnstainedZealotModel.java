...
public class UnstainedZealotModel<T extends UnstainedZealotEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = whole.addOrReplaceChild("body", CubeListBuilder.create().texOffs(33, 15).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(60, 24).addBox(-4.1F, -0.5F, 1.4F, 8.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(56, 88).addBox(4.0F, 0.5F, 1.5F, 4.0F, 15.0F, 3.0F, new CubeDeformation(-0.1F))
                .texOffs(76, 88).addBox(-8.0F, 0.5F, 1.5F, 4.0F, 15.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition rightLeg = whole.addOrReplaceChild("rightLeg", CubeListBuilder.create().texOffs(63, 56).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(93, 10).addBox(-1.1F, 4.0F, -2.75F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
    ...
    @Override
    public void setupAnim(UnstainedZealotEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
