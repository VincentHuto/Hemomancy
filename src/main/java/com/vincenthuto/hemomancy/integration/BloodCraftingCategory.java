...
public class BloodCraftingCategory implements IRecipeCategory<RecipeBaseBloodCrafting> {
	...
	@Override
	public RecipeType<RecipeBaseBloodCrafting> getRecipeType() {
		return JEIPlugin.blood_crafting_recipe_type;
	}
	...
	@Override
	public void draw(RecipeBaseBloodCrafting recipe, IRecipeSlotsView recipeSlotsView, PoseStack matrixStack,
			double mouseX, double mouseY) {
		overlay.draw(matrixStack);

		renderPatternInGUI(matrixStack, Minecraft.getInstance(), recipe.getMultiblockPattern(), mouseX, mouseY);
//		Minecraft.getInstance().font.drawWordWrap( Component.translatable("Held Item"), -50,
//				(int) (Minecraft.getInstance().font.lineHeight) - 22, 150, 0);
//		Minecraft.getInstance().font.drawWordWrap( Component.translatable("Hit Block"), -50,
