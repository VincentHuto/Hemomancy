...
//		return  Component.translatable("Juiceinator");
//	}
//
//	@Nonnull
//	@Override
...
//		if (experience > 0) {
//			TranslatableComponent experienceString = Component.translatable("gui.jei.category.smelting.experience",
//					experience);
...
//			TranslatableComponent timeString = Component.translatable("gui.jei.category.smelting.time.seconds",
//					cookTimeSeconds);
//			Minecraft minecraft = Minecraft.getInstance();
//			Font fontRenderer = minecraft.font;
