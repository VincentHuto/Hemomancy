...
public class ScreenMorphlingJar extends AbstractContainerScreen<MenuMorphlingJar> {
	public ScreenMorphlingJar(MenuMorphlingJar container, Inventory playerInventory, Component name) {
