...
public class ScreenLivingSyringe extends AbstractContainerScreen<MenuLivingSyringe> {
	public ScreenLivingSyringe(MenuLivingSyringe container, Inventory playerInventory, Component name) {
