...
public class GuiLivingStaff extends AbstractContainerScreen<MenuLivingStaff> {
	public GuiLivingStaff(MenuLivingStaff container, Inventory playerInventory, Component name) {
