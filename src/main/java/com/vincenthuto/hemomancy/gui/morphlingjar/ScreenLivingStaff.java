...
public class ScreenLivingStaff extends AbstractContainerScreen<MenuLivingStaff> {
	public ScreenLivingStaff(MenuLivingStaff container, Inventory playerInventory, Component name) {
