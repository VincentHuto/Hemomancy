...
public class ScreenChiselStation extends AbstractContainerScreen<MenuChiselStation> {
	...
	public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		cat1.add(Component.translatable(I18n.get("Clear Runes")));
		...
		cat9.add(Component.translatable(I18n.get("Chisel Rune")));
...
//		}
	...
	protected void renderLabels(PoseStack matrixStack, int x, int y) {
		...
		this.font.draw(matrixStack, Language.getInstance()
				.getVisualOrder(FormattedText.of(this.te.getDisplayName().getContents().toString())), 8, 6, 65444444);
		this.font.draw(matrixStack, Language.getInstance()
				.getVisualOrder(FormattedText.of(this.playerInv.getDisplayName().getContents().toString()))

				, 8, this.imageHeight - 92, 000000);
