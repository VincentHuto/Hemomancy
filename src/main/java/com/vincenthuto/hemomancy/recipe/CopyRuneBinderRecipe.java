...
public class CopyRuneBinderRecipe extends ShapedRecipe {
	public CopyRuneBinderRecipe(final ResourceLocation id, final String group, final int recipeWidth,
	...
	public CopyRuneBinderRecipe(ShapedRecipe shapedRecipe) {
	...
	public static class Serializer implements RecipeSerializer<CopyRuneBinderRecipe> {
		@Nullable
		@Override
		public CopyRuneBinderRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
			return new CopyRuneBinderRecipe(RecipeSerializer.SHAPED_RECIPE.fromNetwork(recipeId, buffer));
		}

		@Override
		public CopyRuneBinderRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
			try {
				return new CopyRuneBinderRecipe(RecipeSerializer.SHAPED_RECIPE.fromJson(recipeId, json));
		...
		@Override
		public void toNetwork(FriendlyByteBuf buffer, CopyRuneBinderRecipe recipe) {
			try {
