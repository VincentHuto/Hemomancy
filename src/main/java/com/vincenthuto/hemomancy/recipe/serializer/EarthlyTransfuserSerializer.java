...
public class EarthlyTransfuserSerializer extends ForgeRegistryEntry<RecipeSerializer<?>>
		implements RecipeSerializer<EarthlyTransfuserRecipe> {

	@Override
	public EarthlyTransfuserRecipe fromJson(ResourceLocation location, JsonObject object) {
		...
		return new EarthlyTransfuserRecipe(location, s, ingredient, itemstack, f, i);
	}

	@Override
	public EarthlyTransfuserRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
	...
	protected EarthlyTransfuserRecipe createRecipe(ResourceLocation recipeId, String group, Ingredient ingredient,
			ItemStack result, float experience, int cookingTime) {
		return new EarthlyTransfuserRecipe(recipeId, group, ingredient, result, experience, cookingTime);
	}

	@Override
	public void toNetwork(FriendlyByteBuf buffer, EarthlyTransfuserRecipe recipe) {
