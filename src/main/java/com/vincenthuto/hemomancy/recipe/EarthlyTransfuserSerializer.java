...
public class EarthlyTransfuserSerializer extends ForgeRegistryEntry<RecipeSerializer<?>>
		implements RecipeSerializer<EarthlyTransfuserDataRecipe> {

	@Override
	public EarthlyTransfuserDataRecipe fromJson(ResourceLocation location, JsonObject object) {
		...
		return new EarthlyTransfuserDataRecipe(location, s, ingredient, itemstack, f, i);
	}

	@Override
	public EarthlyTransfuserDataRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
	...
	protected EarthlyTransfuserDataRecipe createRecipe(ResourceLocation recipeId, String group, Ingredient ingredient,
			ItemStack result, float experience, int cookingTime) {
		return new EarthlyTransfuserDataRecipe(recipeId, group, ingredient, result, experience, cookingTime);
	}

	@Override
	public void toNetwork(FriendlyByteBuf buffer, EarthlyTransfuserDataRecipe recipe) {
