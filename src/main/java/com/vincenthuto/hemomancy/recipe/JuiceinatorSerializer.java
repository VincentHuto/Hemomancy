...
public class JuiceinatorSerializer extends ForgeRegistryEntry<RecipeSerializer<?>>
		implements RecipeSerializer<JuiceinatorDataRecipe> {

	@Override
	public JuiceinatorDataRecipe fromJson(ResourceLocation location, JsonObject object) {
		...
		return new JuiceinatorDataRecipe(location, s, ingredient, itemstack, f, i);
	}

	@Override
	public JuiceinatorDataRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
	...
	protected JuiceinatorDataRecipe createRecipe(ResourceLocation recipeId, String group, Ingredient ingredient,
			ItemStack result, float experience, int cookingTime) {
		return new JuiceinatorDataRecipe(recipeId, group, ingredient, result, experience, cookingTime);
	}

	@Override
	public void toNetwork(FriendlyByteBuf buffer, JuiceinatorDataRecipe recipe) {
