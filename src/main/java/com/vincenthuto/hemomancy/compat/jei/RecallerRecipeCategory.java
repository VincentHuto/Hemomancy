...
/**
 * JEI recipe category for the Visceral Artificial Recaller.
...
public class RecallerRecipeCategory implements IRecipeCategory<RecallerRecipe> {
	...
	public Component getTitle() {
		return Component.translatable("hemomancy.jei.recaller");
	}
	...
	@Override
	public void draw(RecallerRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gfx,
