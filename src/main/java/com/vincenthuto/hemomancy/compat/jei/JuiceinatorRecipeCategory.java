...
/**
 * JEI recipe category for the Juiceinator — fully programmatic rendering.
 */
public class JuiceinatorRecipeCategory implements IRecipeCategory<JuiceinatorRecipe> {
		...
		this.cachedArrows = CacheBuilder.newBuilder().maximumSize(25).build(new CacheLoader<>() {
			...
			public IDrawableAnimated load(Integer cookTime) {
				return guiHelper.drawableBuilder(
						new ResourceLocation(Hemomancy.MOD_ID, "textures/gui/juiceinator_gui_overlay.png"),
						143 + 16, 14, 24, 17
	...
	@Override
	public void draw(JuiceinatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gfx, double mouseX,
			double mouseY) {
		...
		MutableComponent hint = Component.translatable("gui.hemomancy.juiceinator.requires_fire");
