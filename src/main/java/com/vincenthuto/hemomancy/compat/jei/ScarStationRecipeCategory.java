...
public class ScarStationRecipeCategory implements IRecipeCategory<ScarRecipe> {
	...
	// Grid display constants matching the 8x8 Scar Pattern
	...
	public ScarStationRecipeCategory(IGuiHelper guiHelper) {
		background = guiHelper.createBlankDrawable(BG_W, BG_H);
		icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(BlockInit.scar_station.get()));
	}
	...
	@Override
	public void draw(ScarRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gfx, double mouseX,
			double mouseY) {
...
//						(a << 24) | (r << 16) | (g << 8) | b);
	...
	@Override
	public RecipeType<ScarRecipe> getRecipeType() {
		return JEIPlugin.scar_station_recipe_type;
	}

	@Nonnull
	@Override
	public Component getTitle() {
		return Component.translatable("hemomancy.jei.scar_station");
	}

	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, ScarRecipe recipe, IFocusGroup focuses) {
