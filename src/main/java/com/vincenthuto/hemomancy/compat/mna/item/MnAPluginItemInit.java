...
public class MnAPluginItemInit {
	...
	// Faction
	public static final DeferredItem<Item> mark_of_blood = MNAITEMS.register("mark_of_blood",
			() -> new Item(new Item.Properties()));

	public static final DeferredItem<Item> harbinger_grimore = MNAITEMS.register("harbinger_grimore",
	...
	public static final DeferredItem<ItemFactionHorn> faction_horn_harbingers = MNAITEMS.register(
			"faction_horn_harbingers", () -> new ItemFactionHorn(HarbingerEventHandler.FACTION_HARBINGERS_ID));

	// Items

	public static final DeferredItem<Item> befouled_vinteum_dust = MNAITEMS.register("befouled_vinteum_dust",
			() -> new Item(new Item.Properties()));

	public static final DeferredItem<Item> foul_vinteum_ingot = MNAITEMS.register("foul_vinteum_ingot",
			() -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> mana_infushed_memory_blank = MNAITEMS.register("mana_infushed_memory_blank",
			() -> new Item(new Item.Properties()));

	public static final DeferredItem<Item> living_infused_thread = MNAITEMS.register("living_infused_thread",
			() -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> mote_blood = MNAITEMS.register("mote_blood",
			() -> new Item(new Item.Properties()));

	// Memories (MnA-dependent manipulations)
	public static final DeferredItem<Item> mana_memory_sanguine_transfusion = MNAITEMS.register(
	...
	// Robes
	public static final DeferredItem<Item> living_thread_hood = MNAITEMS.register("living_thread_hood",
	...
	public static final DeferredItem<Item> living_thread_robes = MNAITEMS.register("living_thread_robes",
			() -> new DyeableLivingThreadArmor(MnAPluginArmorTiers.LIVING_THREAD, ArmorItem.Type.CHESTPLATE,
					(new Item.Properties()).fireResistant(), 0.25f, 0.01f));
	public static final DeferredItem<Item> living_thread_leggings = MNAITEMS.register("living_thread_leggings",
			() -> new DyeableLivingThreadArmor(MnAPluginArmorTiers.LIVING_THREAD, ArmorItem.Type.LEGGINGS,
					(new Item.Properties()).fireResistant(), 0.25f, 0.01f));
	public static final DeferredItem<Item> living_thread_boots = MNAITEMS.register("living_thread_boots",
