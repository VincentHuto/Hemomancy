...
public class ItemRecycledEnzyme extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
		if (!worldIn.isClientSide) {
			playerIn.displayClientMessage( Component.translatable(String.valueOf(getTend())), false);
			playerIn.displayClientMessage( Component.translatable(String.valueOf(getAmount())), false);
		}
