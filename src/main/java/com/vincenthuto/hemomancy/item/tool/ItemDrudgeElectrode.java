...
//		}
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		tooltip.add( Component.translatable("Used to give and reflect commands to drudges"));
		if (stack.hasTag()) {
			if (stack.getTag().getBoolean(TAG_MODE)) {
				tooltip.add(Component.translatable("State: On").withStyle(ChatFormatting.RED));
			} else {
				tooltip.add(Component.translatable("State: Off").withStyle(ChatFormatting.GRAY));
			}
		}
