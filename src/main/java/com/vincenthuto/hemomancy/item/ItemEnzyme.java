...
public class ItemEnzyme extends Item {
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		...
		tooltip.add( Component.translatable("Tendency: " + tend).withStyle(ChatFormatting.DARK_GREEN));
		tooltip.add( Component.translatable("Amount: " + amount).withStyle(ChatFormatting.GOLD));
