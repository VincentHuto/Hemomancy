...
public class ItemFerventHusk extends Item {
	...
	public Component getName(ItemStack stack) {
		return  Component.translatable(
				HLTextUtils.stringToBloody(HLTextUtils.convertInitToLang(ForgeRegistries.ITEMS.getKey(stack.getItem()).getPath()))).withStyle(ChatFormatting.GOLD);
	}

	@Override
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		super.appendHoverText(stack, worldIn, tooltip, flagIn);
		tooltip.add( Component.translatable("Used to enhance your manipulations"));
	}
