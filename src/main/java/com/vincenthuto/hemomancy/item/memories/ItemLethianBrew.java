...
public class ItemLethianBrew extends Item {

	public ItemLethianBrew(Item.Properties p_42979_) {
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		...
		tooltip.add( Component.translatable("Used to forget ALL your manipulations"));
		tooltip.add( Component.translatable("\"Dont Spill It...\""));
	}
