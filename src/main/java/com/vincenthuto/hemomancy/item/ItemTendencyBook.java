...
public class ItemTendencyBook extends ItemGuideBook {

	public ItemTendencyBook(Properties prop, ResourceLocation loc) {
		super(prop, loc);
	}
	...
	public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
		...
		if (worldIn.isClientSide) {
			// Minecraft.getInstance().setScreen(new GuiTendencyTitlePage(false));
