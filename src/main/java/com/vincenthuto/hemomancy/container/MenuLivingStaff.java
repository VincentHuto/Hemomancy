...
public class MenuLivingStaff extends AbstractContainerMenu {
	public MenuLivingStaff(final int windowId, final Inventory playerInventory) {
		this(windowId, playerInventory.player.level, playerInventory.player.blockPosition(), playerInventory,
				playerInventory.player);
	}
	public MenuLivingStaff(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
		this(windowId, playerInventory);
	}

	public MenuLivingStaff(int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
	...
	public MenuLivingStaff(int openType, int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
