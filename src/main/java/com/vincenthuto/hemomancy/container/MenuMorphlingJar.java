...
public class MenuMorphlingJar extends AbstractContainerMenu {
	public MenuMorphlingJar(final int windowId, final Inventory playerInventory) {
		this(windowId, playerInventory.player.level, playerInventory.player.blockPosition(), playerInventory,
				playerInventory.player);
	}

	public MenuMorphlingJar(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
		this(windowId, playerInventory);
	}

	public MenuMorphlingJar(int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
	...
	public MenuMorphlingJar(int openType, int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
