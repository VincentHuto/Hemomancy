...
public class CharmSlotMenu extends RecipeBookMenu<CraftingContainer> {

	@ObjectHolder("hemomancy:charm_slot_container")
	public static MenuType<CharmSlotMenu> TYPE;
	...
	public CharmSlotMenu(int id, Inventory playerInventory) {
		super(TYPE, id);
		...
		this.addSlot(slotCharm = new CharmSlot(CharmSlotMenu.this.extensionSlot, 77, 44));

		if (playerInventory.player.level.isClientSide) {
			PacketHandler.CHANNELKNOWNMANIPS.sendToServer(new CharmContainerSlotPacket());
		}
	}
