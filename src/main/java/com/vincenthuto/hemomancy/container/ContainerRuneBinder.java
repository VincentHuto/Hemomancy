...
import com.vincenthuto.hemomancy.containers.slot.SlotRuneBinder;
...
public class ContainerRuneBinder extends AbstractContainerMenu {
	public ContainerRuneBinder(final int windowId, final Inventory playerInventory) {
		this(windowId, playerInventory.player.level, playerInventory.player.blockPosition(), playerInventory,
				playerInventory.player);
	}

	public ContainerRuneBinder(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
		this(windowId, playerInventory);
	}

	public ContainerRuneBinder(int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
	...
	public ContainerRuneBinder(int openType, int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
