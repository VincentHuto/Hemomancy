...
import com.vincenthuto.hemomancy.containers.slot.SlotChisel;
import com.vincenthuto.hemomancy.containers.slot.SlotOutput;
import com.vincenthuto.hemomancy.containers.slot.SlotRunePattern;
...
public class MenuChiselStation extends AbstractContainerMenu {
	private final int numRows;
	private final BlockEntityChiselStation te;
	public int[] activatedRunes;

	public MenuChiselStation(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
		this(windowId, playerInventory, getBlockEntity(playerInventory, data));
	}

	public MenuChiselStation(final int windowId, final Inventory playerInv, final BlockEntityChiselStation te) {
