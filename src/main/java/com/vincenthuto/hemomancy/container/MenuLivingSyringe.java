...
public class MenuLivingSyringe extends AbstractContainerMenu {
	public MenuLivingSyringe(final int windowId, final Inventory playerInventory) {
		this(windowId, playerInventory.player.level, playerInventory.player.blockPosition(), playerInventory,
				playerInventory.player);
	}

	public MenuLivingSyringe(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
		this(windowId, playerInventory);
	}

	public MenuLivingSyringe(int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
	...
	public MenuLivingSyringe(int openType, int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
