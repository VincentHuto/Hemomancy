...
import com.vincenthuto.hemomancy.containers.slot.SlotMorphlingJar;
...
public class ContainerMorphlingJar extends AbstractContainerMenu {
	...
	public ContainerMorphlingJar(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
