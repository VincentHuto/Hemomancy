...
public class MenuRuneBinderViewer extends AbstractContainerMenu {
	...
	public MenuRuneBinderViewer(final int windowId, final Inventory playerInventory, final FriendlyByteBuf data) {
	...
	public MenuRuneBinderViewer(int windowId, Level world, BlockPos pos, Inventory playerInventory,
			Player playerEntity) {
		super(ContainerInit.rune_binder_container.get(), windowId);
