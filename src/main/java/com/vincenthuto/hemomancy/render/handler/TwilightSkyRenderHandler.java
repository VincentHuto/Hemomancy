...
@OnlyIn(Dist.CLIENT)
public class TwilightSkyRenderHandler implements ISkyRenderHandler {

	private VertexBuffer starVBO;
	private final VertexFormat vertexBufferFormat = DefaultVertexFormat.POSITION;

	public TwilightSkyRenderHandler() {
		generateStars();
	}

	// [VanillaCopy] RenderGlobal.renderSky's overworld branch, without
	// sun/moon/sunrise/sunset, and using our own stars at full brightness
	@Override
	@OnlyIn(Dist.CLIENT)
...
//		RenderHelper.disableStandardItemLighting();
		/*
		 * TF - snip out sunrise/sunset since that doesn't happen here float[] afloat =
		 * ... if (afloat != null) ...
		 */
		...
		/*
		 * TF - snip out sun/moon float f17 = 30.0F; ... tessellator.draw();
		 */
