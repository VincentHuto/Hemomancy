...
public class RenderBloodArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
	...
	public RenderBloodArmorLayer(LivingEntityRenderer<T, M> owner) {
		super(owner);
	}
