...
public class LayerEnthralledDollGlow<T extends LivingEntity> extends EyesLayer<T, ModelEnthralledDoll<T>> {
	...
	public LayerEnthralledDollGlow(RenderLayerParent<T, ModelEnthralledDoll<T>> p_116981_) {
		super(p_116981_);
