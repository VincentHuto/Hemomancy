...
public class LayerBloodArmor<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
	...
	public LayerBloodArmor(LivingEntityRenderer<T, M> owner) {
		super(owner);
	}
