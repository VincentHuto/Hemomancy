...
public class RenderItemBarbedShield extends BlockEntityWithoutLevelRenderer {

	private final ModelBarbedShield modelShield;
	...
	public RenderItemBarbedShield(BlockEntityRenderDispatcher p_172550_, EntityModelSet p_172551_) {
		super(p_172550_, p_172551_);
		modelShield = new ModelBarbedShield(p_172551_.bakeLayer(ModelBarbedShield.barbed_shield));
	}
