...
import com.vincenthuto.hemomancy.render.layer.LayerEnthralledDollGlow;
...
public class RenderEnthralledDoll extends MobRenderer<EntityEnthralledDoll, ModelEnthralledDoll<EntityEnthralledDoll>> {
	...
	public RenderEnthralledDoll(Context renderManagerIn) {
		super(renderManagerIn, new ModelEnthralledDoll<EntityEnthralledDoll>(
				renderManagerIn.bakeLayer(ModelEnthralledDoll.LAYER_LOCATION)), 0.1F);
		this.addLayer(new LayerEnthralledDollGlow<>(this));

	}

	@Override
	public void render(EntityEnthralledDoll pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
...
//				
	...
	@Override
	public ResourceLocation getTextureLocation(EntityEnthralledDoll entity) {
		return TEXTURE;
