...
public class BlockEntityScryingPodium extends BlockEntity {

	public BlockEntityScryingPodium(BlockPos pos, BlockState state) {
		super(BlockEntityInit.scrying_podium.get(), pos, state);
	}

	@SuppressWarnings("unused")
	public static void animTick(Level level, BlockPos pos, BlockState state, BlockEntityScryingPodium ent) {
