...
public class EntityInit {
    ...
    // Mobs
    public static final RegistryObject<EntityType<UnstainedZealotEntity>> unstained_zealot = ENTITY_TYPES.register(
            "unstained_zealot",
    ...
    public static final RegistryObject<EntityType<HarbingerAlchemistEntity>> harbinger_alchemist = ENTITY_TYPES.register(
            "harbinger_alchemist",
    ...
    public static final RegistryObject<EntityType<SanguisLanceaEntity>> sanguis_lancea = ENTITY_TYPES.register(
