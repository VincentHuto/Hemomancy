...
public class BlockInit {
	public static final DeferredRegister.Blocks BASEBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks SLABBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks STAIRBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks COLUMNBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks CROSSBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks OBJBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks MODELEDBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);
	public static final DeferredRegister.Blocks SPECIALBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);

	public static final DeferredRegister.Blocks POTTEDBLOCKS = DeferredRegister.createBlocks(Hemomancy.MOD_ID);

	// Ash
	public static final DeferredBlock<Block> smouldering_ash_trail = SPECIALBLOCKS.register("smouldering_ash_trail",
			() -> new SmoulderingAshTrailBlock(BlockBehaviour.Properties.of().noCollission().instabreak()));

	public static final DeferredBlock<Block> befouling_ash_trail = SPECIALBLOCKS.register("befouling_ash_trail",
			() -> new BefoulingAshTrailBlock(BlockBehaviour.Properties.of().noCollission().instabreak()));

	public static final DeferredBlock<Block> active_smouldering_ash_trail = SPECIALBLOCKS.register(
			"active_smouldering_ash_trail",
			() -> new ActiveSmoulderingAshTrailBlock(BlockBehaviour.Properties.of().noCollission().instabreak()));
	public static final DeferredBlock<Block> active_befouling_ash_trail = SPECIALBLOCKS.register(
			"active_befouling_ash_trail",
			() -> new ActiveBefoulingAshTrailBlock(BlockBehaviour.Properties.of().noCollission().instabreak()));

	public static final DeferredBlock<Block> engram_block = SPECIALBLOCKS.register("engram_block", EngramBlock::new);

	public static final DeferredBlock<Block> filler_block = SPECIALBLOCKS.register("filler_block",
			() -> new FillerBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3600000.0F).noOcclusion().noLootTable()));

	public static final DeferredBlock<Block> qliphoth_bloom = SPECIALBLOCKS.register("qliphoth_bloom",
	...
	public static final DeferredBlock<Block> sanguine_glass = BASEBLOCKS.register("sanguine_glass",
			() -> new GlassBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> sanguine_pane = SPECIALBLOCKS.register("sanguine_pane",
			() -> new IronBarsBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> vivianite_glass = BASEBLOCKS.register("vivianite_glass",
			() -> new GlassBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> vivianite_pane = SPECIALBLOCKS.register("vivianite_pane",
			() -> new IronBarsBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> cleansed_sanguine_glass = BASEBLOCKS.register("cleansed_sanguine_glass",
			() -> new GlassBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> cleansed_sanguine_pane = SPECIALBLOCKS.register("cleansed_sanguine_pane",
			() -> new IronBarsBlock(
					BlockBehaviour.Properties.of().strength(0.1f, 1f).sound(SoundType.GLASS).noOcclusion()));

	public static final DeferredBlock<Block> venous_stone = BASEBLOCKS.register("venous_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));

	public static final DeferredBlock<Block> venous_stone_slab = SLABBLOCKS.register("venous_stone_slab",
			() -> new SlabBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5f, 6.0F)));
	public static final DeferredBlock<Block> venous_stone_stairs = BASEBLOCKS.register(("venous_stone_stairs"),
			() -> new StairBlock(() -> venous_stone.get().defaultBlockState(),
					BlockBehaviour.Properties.copy(venous_stone.get())));

	public static final DeferredBlock<Block> gilded_venous_stone = BASEBLOCKS.register("gilded_venous_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone = BASEBLOCKS.register("polished_venous_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone_slab = SLABBLOCKS.register(
			"polished_venous_stone_slab",
			() -> new SlabBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5f, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone_stairs = STAIRBLOCKS.register(
			("polished_venous_stone_stairs"), () -> new StairBlock(() -> venous_stone.get().defaultBlockState(),
					BlockBehaviour.Properties.copy(venous_stone.get())));
	public static final DeferredBlock<Block> chiseled_polished_venous_stone = BASEBLOCKS.register(
			"chiseled_polished_venous_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone_bricks = STAIRBLOCKS.register(
			"polished_venous_stone_bricks",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone_brick_slab = SLABBLOCKS.register(
			"polished_venous_stone_brick_slab",
			() -> new SlabBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5f, 6.0F)));
	public static final DeferredBlock<Block> polished_venous_stone_brick_stairs = STAIRBLOCKS.register(
			("polished_venous_stone_brick_stairs"), () -> new StairBlock(() -> venous_stone.get().defaultBlockState(),
					BlockBehaviour.Properties.copy(venous_stone.get())));
	public static final DeferredBlock<Block> cracked_polished_venous_stone_bricks = BASEBLOCKS.register(
			"cracked_polished_venous_stone_bricks",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));

	public static final DeferredBlock<Block> infested_venous_stone = BASEBLOCKS.register("infested_venous_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)));

	public static final DeferredBlock<Block> conscious_mass = BASEBLOCKS.register("conscious_mass",
			() -> new Block(BlockBehaviour.Properties.of().sound(SoundType.WART_BLOCK).strength(0.2F, 1.0F)));

	// Fungal dimension ores
	public static final DeferredBlock<Block> hematic_iron_ore = BASEBLOCKS.register("hematic_iron_ore",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)
					.sound(SoundType.NETHER_ORE)));

	// New fungal dimension blocks
	public static final DeferredBlock<Block> calcified_hyphae = BASEBLOCKS.register("calcified_hyphae",
			() -> new Block(BlockBehaviour.Properties.of().strength(2.0F, 6.0F).sound(SoundType.BONE_BLOCK)));

	public static final DeferredBlock<Block> hemorrhagic_crust = BASEBLOCKS.register("hemorrhagic_crust",
			() -> new Block(BlockBehaviour.Properties.of().strength(1.5F, 4.0F).sound(SoundType.NETHERRACK)));

	public static final DeferredBlock<Block> sporite_crystal = BASEBLOCKS.register("sporite_crystal",
			() -> new Block(BlockBehaviour.Properties.of().strength(1.5F, 3.0F).sound(SoundType.AMETHYST)
					.lightLevel((state) -> 10).noOcclusion()));

	public static final DeferredBlock<Block> hematic_iron_block = BASEBLOCKS.register("hematic_iron_block",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F)
					.sound(SoundType.METAL)));
	public static final DeferredBlock<Block> hematic_iron_pillar = COLUMNBLOCKS.register("hematic_iron_pillar",
			() -> new RotatedPillarBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(5.0F, 6.0F).sound(SoundType.METAL)));

	public static final DeferredBlock<Block> chiseled_hematic_iron_block = BASEBLOCKS
			.register("chiseled_hematic_iron_block", () -> new Block(BlockBehaviour.Properties.of()
					.requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL)));

	public static final DeferredBlock<Block> hemolytic_plating_block = BASEBLOCKS.register("hemolytic_plating_block",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F)
					.sound(SoundType.METAL)));

	public static final DeferredBlock<Block> crimson_flames = SPECIALBLOCKS.register("crimson_flames",
            CrimsonFlameBlock::new);

	public static final DeferredBlock<Block> mnemonic_reliquary = SPECIALBLOCKS.register("mnemonic_reliquary",
			MnemonicReliquaryBlock::new);

	// Plants

	public static final DeferredBlock<Block> blood_wood_log = COLUMNBLOCKS.register("blood_wood_log",
			() -> new RotatedPillarBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final DeferredBlock<Block> blood_wood_planks = BASEBLOCKS.register("blood_wood_planks",
			() -> new Block(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD)));

	public static final DeferredBlock<Block> hyphae = CROSSBLOCKS.register("hyphae",
	...
	public static final DeferredBlock<Block> bleeding_heart = CROSSBLOCKS.register("bleeding_heart",
	...
	public static final DeferredBlock<Block> potted_bleeding_heart = POTTEDBLOCKS.register("potted_bleeding_heart",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.bleeding_heart,
					BlockBehaviour.Properties.of()));

	public static final DeferredBlock<Block> infected_fungus = CROSSBLOCKS.register("infected_fungus",
			() -> new InfectedFungusBlock(MobEffects.CONFUSION, 12,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> potted_infected_fungus = POTTEDBLOCKS.register("potted_infected_fungus",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.infected_fungus,
					BlockBehaviour.Properties.of().noCollission()));

	public static final DeferredBlock<Block> puffball_fungus = MODELEDBLOCKS.register("puffball_fungus",
			() -> new PuffballFungusBlock(MobEffects.SATURATION, 12,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> potted_puffball_fungus = POTTEDBLOCKS.register("potted_puffball_fungus",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.puffball_fungus,
					BlockBehaviour.Properties.of().noCollission()));

	public static final DeferredBlock<Block> stinkhorn_fungus = CROSSBLOCKS.register("stinkhorn_fungus",
			() -> new InfectedFungusBlock(MobEffects.CONFUSION, 12,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> potted_stinkhorn_fungus = POTTEDBLOCKS.register("potted_stinkhorn_fungus",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.stinkhorn_fungus,
					BlockBehaviour.Properties.of().noCollission()));

	public static final DeferredBlock<Block> devils_tooth = CROSSBLOCKS.register("devils_tooth",
			() -> new DevilsToothBlock(MobEffects.CONFUSION, 12,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> lethean_poppy = CROSSBLOCKS.register("lethean_poppy",
	...
	public static final DeferredBlock<Block> erythrocytic_dirt = BASEBLOCKS.register("erythrocytic_dirt",
			() -> new Block(
					BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL)));

	public static final DeferredBlock<Block> erythrocytic_mycelium = BASEBLOCKS.register("erythrocytic_mycelium",
	...
	public static final DeferredBlock<Block> infected_stem = BASEBLOCKS.register("infected_stem",
			() -> new Block(BlockBehaviour.Properties.of().strength(0.5f, 15f).sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> hyphae_block = BASEBLOCKS.register("hyphae_block",
			() -> new Block(BlockBehaviour.Properties.of().strength(0.5f, 15f).sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> infected_cap = BASEBLOCKS.register("infected_cap",
			() -> new InfectedCapBlock(BlockBehaviour.Properties.of().strength(0.5f, 15f).sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> fruiting_infected_cap = BASEBLOCKS.register("fruiting_infected_cap",
			() -> new InfectedCapBlock(BlockBehaviour.Properties.of().strength(0.5f, 15f).sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> infested_wood = BASEBLOCKS.register("infested_wood",
			() -> new InfestedWoodBlock(BlockBehaviour.Properties.of().strength(1.5F, 3.0F).sound(SoundType.WOOD)
					.randomTicks()));

	// Myco-heterotrophic Plants

	public static final DeferredBlock<Block> ghost_pipe = CROSSBLOCKS.register("ghost_pipe",
			() -> new GhostPipeBlock(MobEffects.NIGHT_VISION, 10,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));

	public static final DeferredBlock<Block> sarcodes = CROSSBLOCKS.register("sarcodes",
			() -> new SarcodesBlock(MobEffects.REGENERATION, 8,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS)));

	public static final DeferredBlock<Block> rafflesia = CROSSBLOCKS.register("rafflesia",
			() -> new RafflesiaBlock(MobEffects.CONFUSION, 12,
					BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS).randomTicks()));

	public static final DeferredBlock<Block> potted_ghost_pipe = POTTEDBLOCKS.register("potted_ghost_pipe",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.ghost_pipe,
					BlockBehaviour.Properties.of().noCollission()));

	public static final DeferredBlock<Block> potted_sarcodes = POTTEDBLOCKS.register("potted_sarcodes",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.sarcodes,
					BlockBehaviour.Properties.of().noCollission()));

	public static final DeferredBlock<Block> potted_lethean_poppy = POTTEDBLOCKS.register("potted_lethean_poppy",
			() -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.lethean_poppy,
					BlockBehaviour.Properties.of().noCollission()));

	// Gourd
	public static final DeferredBlock<Block> gourd = MODELEDBLOCKS.register("gourd",
	...
	public static final DeferredBlock<Block> attached_gourd_stem = MODELEDBLOCKS.register("attached_gourd_stem",
	...
	public static final DeferredBlock<Block> gourd_stem = MODELEDBLOCKS.register("gourd_stem",
	...
	// Idols
	public static final DeferredBlock<Block> humane_idol = MODELEDBLOCKS.register("humane_idol",
			() -> new BlockHumaneIdol(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)
					.sound(SoundType.STONE)));
	public static final DeferredBlock<Block> serpentine_idol = MODELEDBLOCKS.register("serpentine_idol",
			() -> new BlockSerpentineIdol(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	// Tiles
	public static final DeferredBlock<Block> scar_station = MODELEDBLOCKS.register("scar_station",
	...
	public static final DeferredBlock<Block> morphling_incubator = MODELEDBLOCKS.register("morphling_incubator",
			() -> new MorphlingIncubatorBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> morphling_cradle = MODELEDBLOCKS.register("morphling_cradle",
			() -> new MorphlingCradleBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> semi_sentient_construct = MODELEDBLOCKS
	...
	public static final DeferredBlock<Block> unstained_podium = MODELEDBLOCKS.register("unstained_podium",
			() -> new UnstainedPodiumBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> altar_of_cleansing = MODELEDBLOCKS.register("altar_of_cleansing",
	...
	public static final DeferredBlock<Block> cleansed_stone = BASEBLOCKS.register("cleansed_stone",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> pale_silver_block = BASEBLOCKS.register("pale_silver_block",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(3.0F, 6.0F).sound(SoundType.METAL)));

	public static final DeferredBlock<Block> pale_silver_bells = BASEBLOCKS.register("pale_silver_bells",
	...
	public static final DeferredBlock<Block> pallid_lantern = BASEBLOCKS.register("pallid_lantern",
			() -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.0F, 3.0F).sound(SoundType.LANTERN).lightLevel(s -> 12)));

	public static final DeferredBlock<Block> scrying_podium = MODELEDBLOCKS.register("scrying_podium",
			() -> new ScryingPodiumBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> fungal_podium = MODELEDBLOCKS.register("fungal_podium",
			() -> new FungalPodiumBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> saint_sarcophagus = MODELEDBLOCKS.register("saint_sarcophagus",
	...
	public static final DeferredBlock<Block> sanguine_monolith = MODELEDBLOCKS.register("sanguine_monolith",
	...
	public static final DeferredBlock<Block> fungal_implantation_pylon = MODELEDBLOCKS
			.register("fungal_implantation_pylon", () -> new FungalImplantationPylonBlock(BlockBehaviour.Properties.of()
					.requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> dendritic_distributor = MODELEDBLOCKS.register("dendritic_distributor",
			() -> new DendriticDistributorBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> mortal_display = MODELEDBLOCKS.register("mortal_display",
			() -> new MortalDisplayBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> somatic_loom = MODELEDBLOCKS
			.register("somatic_loom", () -> new SomaticLoomBlock(BlockBehaviour.Properties.of()
					.requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> earthen_vein = MODELEDBLOCKS.register("earthen_vein",
			() -> new EarthenVeinBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)
					.sound(SoundType.STONE)));
	public static final DeferredBlock<Block> iron_brazier = MODELEDBLOCKS.register("iron_brazier",
			() -> new BrazierBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)
					.sound(SoundType.METAL)));
	public static final DeferredBlock<Block> ghastly_alembic = MODELEDBLOCKS.register("ghastly_alembic",
			() -> new GhastlyAlembicBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)
					.sound(SoundType.METAL)));
	public static final DeferredBlock<Block> pallid_retort = MODELEDBLOCKS.register("pallid_retort",
			() -> new PallidRetortBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F, 6.0F)
					.sound(SoundType.METAL)));

	public static final DeferredBlock<Block> vial_centrifuge = MODELEDBLOCKS.register("vial_centrifuge",
			() -> new VialCentrifugeBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.METAL)));

	public static final DeferredBlock<Block> blood_crystal = MODELEDBLOCKS.register("blood_crystal",
			() -> new BloodCrystalBlock(BlockBehaviour.Properties.of().noOcclusion().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.METAL)));

	public static final DeferredBlock<Block> suspended_vivianite = MODELEDBLOCKS.register("suspended_vivianite",
	...
	public static final DeferredBlock<Block> suspended_blood_crystal = MODELEDBLOCKS.register("suspended_blood_crystal",
			() -> new SuspendedBloodCrystalBlock(BlockBehaviour.Properties.of().noOcclusion().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.AMETHYST)));

	public static final DeferredBlock<Block> suspended_cleansed_blood_crystal = MODELEDBLOCKS.register("suspended_cleansed_blood_crystal",
			() -> new SuspendedCleansedBloodCrystalBlock(BlockBehaviour.Properties.of().noOcclusion().requiresCorrectToolForDrops()
					.strength(1.5F, 6.0F).sound(SoundType.AMETHYST)));

	public static final DeferredBlock<Block> bog_body = MODELEDBLOCKS.register("bog_body",
			() -> new BogBodyBlock(BlockBehaviour.Properties.of().noOcclusion().strength(1.5F, 6.0F).sound(SoundType.WART_BLOCK)));

	public static final DeferredBlock<Block> visceral_mirror = MODELEDBLOCKS.register("visceral_mirror",
	...
	public static final DeferredBlock<Block> blood_basin = MODELEDBLOCKS.register("blood_basin",
			() -> new BloodBasinBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(2.0F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> offering_gate = SPECIALBLOCKS.register("offering_gate",
			() -> new OfferingGateBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(3.0F, 8.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> blood_pylon = MODELEDBLOCKS.register("blood_pylon",
			() -> new BloodPylonBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops()
					.strength(2.0F, 6.0F).sound(SoundType.STONE)));

	public static final DeferredBlock<Block> blood_trial_altar = MODELEDBLOCKS.register("blood_trial_altar",
	...
	public static List<Block> getAllBlockEntries() {
		...
		BASEBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		SLABBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		STAIRBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		COLUMNBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		CROSSBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		OBJBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		MODELEDBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		SPECIALBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
		POTTEDBLOCKS.getEntries().stream().map(DeferredHolder::get).forEach(b -> blocks.add(b));
	...
	public static Stream<DeferredHolder<Block, ? extends Block>> getAllBlockEntriesAsStream() {
		...
		Stream<DeferredHolder<Block, ? extends Block>> combinedStream = Stream.of(BASEBLOCKS.getEntries(), SLABBLOCKS.getEntries(),
