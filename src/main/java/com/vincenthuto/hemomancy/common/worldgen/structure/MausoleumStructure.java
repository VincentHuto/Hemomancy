...
public class MausoleumStructure extends Structure {
	...
	public MausoleumStructure(StructureSettings config, Holder<StructureTemplatePool> startPool,
	...
	public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
		if (!StructurePlacementChecks.isSuitableBuriedMausoleumSite(context)) {
