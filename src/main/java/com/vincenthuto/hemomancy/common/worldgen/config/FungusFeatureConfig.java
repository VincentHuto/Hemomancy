...
public class FungusFeatureConfig implements FeatureConfiguration {
	...
	public static final Codec<FungusFeatureConfig> CODEC = RecordCodecBuilder.create((p_67751_) -> {
		      ...
		      })).apply(p_67751_, FungusFeatureConfig::new);
		   });
		   public final BlockStateProvider capProvider;
		   public final BlockStateProvider stemProvider;
		   public final int foliageRadius;

		   public FungusFeatureConfig(BlockStateProvider p_67745_, BlockStateProvider p_67746_, int p_67747_) {
