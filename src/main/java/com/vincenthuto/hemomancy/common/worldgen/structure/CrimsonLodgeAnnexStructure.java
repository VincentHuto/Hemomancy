...
public class CrimsonLodgeAnnexStructure extends Structure {
	private static final ResourceLocation PLACEHOLDER_ID = Hemomancy.rloc("random/lodge_minutes");
	private static final List<ResourceLocation> REPLACEMENTS = List.of(
			Hemomancy.rloc("crimson_lodge/minutes_1"),
			Hemomancy.rloc("crimson_lodge/minutes_2"),
			Hemomancy.rloc("crimson_lodge/minutes_3"),
			Hemomancy.rloc("crimson_lodge/minutes_4"),
			Hemomancy.rloc("crimson_lodge/minutes_5"),
			Hemomancy.rloc("crimson_lodge/minutes_6"));

	public static final MapCodec<CrimsonLodgeAnnexStructure> CODEC = RecordCodecBuilder
			.<CrimsonLodgeAnnexStructure>mapCodec(instance -> instance.group(
							CrimsonLodgeAnnexStructure.settingsCodec(instance),
					...
					.apply(instance, CrimsonLodgeAnnexStructure::new));
	...
	public CrimsonLodgeAnnexStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool,
	...
	public StructureType<?> type() {
		return StructureInit.crimson_lodge_annex.get();
	}
