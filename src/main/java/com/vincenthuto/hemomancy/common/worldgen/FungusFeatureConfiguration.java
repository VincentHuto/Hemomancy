...
public class FungusFeatureConfiguration implements FeatureConfiguration {
	
	public static final Codec<FungusFeatureConfiguration> CODEC = RecordCodecBuilder.create((p_67751_) -> {
		      ...
		      })).apply(p_67751_, FungusFeatureConfiguration::new);
		   });
		   public final BlockStateProvider capProvider;
		   public final BlockStateProvider stemProvider;
		   public final int foliageRadius;

		   public FungusFeatureConfiguration(BlockStateProvider p_67745_, BlockStateProvider p_67746_, int p_67747_) {
