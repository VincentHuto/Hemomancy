...
public class HermitageRemnantStructure extends Structure {
	public static final MapCodec<HermitageRemnantStructure> CODEC = RecordCodecBuilder
			.<HermitageRemnantStructure>mapCodec(instance -> instance.group(
							HermitageRemnantStructure.settingsCodec(instance),
					...
					.apply(instance, HermitageRemnantStructure::new));
	...
	public HermitageRemnantStructure(StructureSettings config, Holder<StructureTemplatePool> startPool,
	...
	public StructureType<?> type() {
		return StructureInit.hermitage_remnant.get();
	}
}
