...
//			// System.out.println("BRIGHT" + player.level().getBrightness(LightLayer.BLOCK,
...
//		}
	...
	public void onEquipped(LivingEntity player) {
		...
		player.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, -1, 1, true, true));
		player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, -1, 1, true, true));
		player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, -1, 1, true, true));
