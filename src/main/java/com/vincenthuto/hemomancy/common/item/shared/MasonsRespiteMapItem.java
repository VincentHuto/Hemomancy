...
public class MasonsRespiteMapItem extends Item {
	private static final TagKey<Structure> TARGETS = TagKey.create(
			Registries.STRUCTURE, Hemomancy.rloc("masons_respite_map_targets"));
	private static final int SEARCH_RADIUS = 100;

	public MasonsRespiteMapItem(Properties properties) {
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
		...
		if (target == null) {
			player.displayClientMessage(
					Component.translatable("item.hemomancy.masons_respite_map.not_found")
		...
		player.displayClientMessage(
				Component.translatable("item.hemomancy.masons_respite_map.points",
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.translatable("item.hemomancy.masons_respite_map.tooltip")
				.withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
		tooltip.add(Component.translatable("item.hemomancy.masons_respite_map.tooltip.use")
