 ...
 * net.minecraft.data.worldgen.placement.PlacementUtils; import
 * net.minecraft.data.worldgen.placement.VegetationPlacements; import
 * net.minecraft.resources.ResourceKey; import
 * net.minecraft.resources.ResourceLocation; import
 * net.minecraft.world.entity.MobCategory; import
 * net.minecraft.world.level.biome.Biome; import
 * net.minecraft.world.level.biome.MobSpawnSettings; import
 * net.minecraft.world.level.block.Block; import
 * net.minecraft.world.level.levelgen.GenerationStep; import
 * net.minecraft.world.level.levelgen.feature.ConfiguredFeature; import
 * net.minecraft.world.level.levelgen.feature.Feature; import
 * net.minecraft.world.level.levelgen.feature.configurations.
 * FeatureConfiguration; import
 * net.minecraft.world.level.levelgen.feature.configurations.OreConfiguration;
 * import net.minecraft.world.level.levelgen.feature.configurations.
 * RandomPatchConfiguration; import
 * net.minecraft.world.level.levelgen.feature.configurations.
 * SimpleBlockConfiguration; import
 ...
 * import net.minecraft.world.level.levelgen.placement.BiomeFilter; import
 * net.minecraft.world.level.levelgen.placement.CountPlacement; import
 * net.minecraft.world.level.levelgen.placement.HeightRangePlacement; import
 * net.minecraft.world.level.levelgen.placement.InSquarePlacement; import
 * net.minecraft.world.level.levelgen.placement.PlacedFeature; import
 * net.minecraft.world.level.levelgen.placement.PlacementModifier; import
 * net.minecraft.world.level.levelgen.placement.RarityFilter; import
 * net.minecraftforge.common.BiomeDictionary; import
 * net.minecraftforge.common.world.BiomeGenerationSettingsBuilder; import
 * net.minecraftforge.common.world.MobSpawnSettingsBuilder; import
 * net.minecraftforge.event.world.BiomeLoadingEvent; import
 ...
 * VENOUS_PLACEMENT; public static Holder<ConfiguredFeature<OreConfiguration,
 * ?>> VENOUS_FEATURE; public static Holder<ConfiguredFeature<TreeConfiguration,
...
/*
 * public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>>
 * flower(String name, int tries, Supplier<? extends Block> flower) { return
 * feature(name, Feature.RANDOM_PATCH,
 ...
 *//**
	 ...
	 */
/*
 * public static Holder<PlacedFeature> flowerPlacement(String name, Holder<?
 ...
 *//**
	 ...
	 */
/*
 * public static Holder<ConfiguredFeature<OreConfiguration, ?>> ore(String name,
 * Supplier<? extends Block> ore, Supplier<? extends Block> deepslateOre, int
 * veinSize, float airExposureDiscardChance) { return feature(name, Feature.ORE,
 ...
 *//**
	 ...
	 */
/*
 * public static Holder<ConfiguredFeature<OreConfiguration, ?>> netherOre(String
 * name, Supplier<? extends Block> ore, Supplier<? extends Block> deepslateOre,
 * int veinSize, float airExposureDiscardChance) { return feature(name,
 ...
 *//**
	 ...
	 */
/*
 * public static Holder<PlacedFeature> orePlacement(String name, Holder<?
 * extends ConfiguredFeature<?, ?>> feature, int veinCount, HeightRangePlacement
 ...
 *//**
	 ...
	 */
/*
 * public static Holder<ConfiguredFeature<TreeConfiguration, ?>> tree(String
 * name, Supplier<? extends Block> log, TrunkPlacer trunk, Supplier<? extends
 * Block> leaves, FoliagePlacer foliage, FeatureSize size) { return
 * feature(name, Feature.TREE, new
 ...
 *//**
	 ...
	 * @return A placed feature based on the given parameters.
	 *//*
		 * public static Holder<PlacedFeature> treeVegetation(String name, Holder<?
		 * extends ConfiguredFeature<?, ?>> feature, PlacementModifier modifier, int
		 * rarity, Supplier<? extends Block> sapling) { List<PlacementModifier> list =
		 ...
		 * event.getName(); Biome.BiomeCategory category = event.getCategory(); if
