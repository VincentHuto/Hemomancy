...
public class ModelChitiniteArmor<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static final Lazy<ModelChitiniteArmor<LivingEntity>> helmet = Lazy.of(() -> new ModelChitiniteArmor<>(
			Minecraft.getInstance().getEntityModels().bakeLayer(CHITINITE_HELMET_LAYER)));
	public static final Lazy<ModelChitiniteArmor<LivingEntity>> chest = Lazy.of(() -> new ModelChitiniteArmor<>(
			Minecraft.getInstance().getEntityModels().bakeLayer(CHITINITE_CHEST_LAYER)));
	public static final Lazy<ModelChitiniteArmor<LivingEntity>> legs = Lazy.of(
			() -> new ModelChitiniteArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(CHITINITE_LEGS_LAYER)));
	public static final Lazy<ModelChitiniteArmor<LivingEntity>> boots = Lazy.of(
			() -> new ModelChitiniteArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(CHITINITE_FEET_LAYER)));

	public ModelChitiniteArmor(ModelPart root) {
