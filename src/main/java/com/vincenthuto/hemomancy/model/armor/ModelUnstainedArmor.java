...
public class ModelUnstainedArmor<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static final Lazy<ModelUnstainedArmor<LivingEntity>> helmet = Lazy.of(() -> new ModelUnstainedArmor<>(
			Minecraft.getInstance().getEntityModels().bakeLayer(UNSTAINED_HELMET_LAYER)));
	public static final Lazy<ModelUnstainedArmor<LivingEntity>> chest = Lazy.of(() -> new ModelUnstainedArmor<>(
			Minecraft.getInstance().getEntityModels().bakeLayer(UNSTAINED_CHEST_LAYER)));
	public static final Lazy<ModelUnstainedArmor<LivingEntity>> legs = Lazy.of(
			() -> new ModelUnstainedArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(UNSTAINED_LEGS_LAYER)));
	public static final Lazy<ModelUnstainedArmor<LivingEntity>> boots = Lazy.of(
