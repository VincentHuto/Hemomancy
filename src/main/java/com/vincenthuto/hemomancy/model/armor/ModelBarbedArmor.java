...
public class ModelBarbedArmor<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static final Lazy<ModelBarbedArmor<LivingEntity>> helmet = Lazy
			.of(() -> new ModelBarbedArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(BARBED_HELMET_LAYER)));
	public static final Lazy<ModelBarbedArmor<LivingEntity>> chest = Lazy
			.of(() -> new ModelBarbedArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(BARBED_CHEST_LAYER)));
	public static final Lazy<ModelBarbedArmor<LivingEntity>> legs = Lazy
			.of(() -> new ModelBarbedArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(BARBED_LEGS_LAYER)));
	public static final Lazy<ModelBarbedArmor<LivingEntity>> boots = Lazy
			.of(() -> new ModelBarbedArmor<>(Minecraft.getInstance().getEntityModels().bakeLayer(BARBED_FEET_LAYER)));

	public ModelBarbedArmor(ModelPart root) {
	...
	public static LayerDefinition createHeadLayer(EquipmentSlot slot) {
		...
		if (slot.equals(EquipmentSlot.HEAD)) {
			...
			PartDefinition spike5 = head.addOrReplaceChild("spike5", CubeListBuilder.create().texOffs(13, 78)
					...
					.addBox(-1.4127F, -0.0286F, 0.373F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike12 = head.addOrReplaceChild("spike12", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-1.4127F, -0.5286F, -0.627F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-1.4127F, -0.0286F, 0.373F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-2.4127F, -0.0286F, -0.627F, 6.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
					PartPose.offsetAndRotation(-2.1667F, -9.5F, -3.4167F, 0.0F, 2.7053F, -2.0071F));

			PartDefinition spike15 = head.addOrReplaceChild("spike15", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-1.4127F, -0.5286F, -0.627F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-1.4127F, -0.0286F, 0.373F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-2.4127F, -0.0286F, -0.627F, 6.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
			...
			PartDefinition spike8 = head.addOrReplaceChild("spike8", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-1.0151F, -2.6499F, -2.9383F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-1.0151F, -2.1499F, -1.9383F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike10 = head.addOrReplaceChild("spike10", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-0.6175F, -4.7712F, -5.2496F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-0.6175F, -4.2712F, -4.2496F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike6 = head.addOrReplaceChild("spike6", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-6.4148F, 8.2496F, 6.5168F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-6.4148F, 8.7496F, 7.5168F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike7 = head.addOrReplaceChild("spike7", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-6.0172F, 10.3709F, 4.2055F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-6.0172F, 10.8709F, 5.2055F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike9 = head.addOrReplaceChild("spike9", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-5.6197F, 12.4922F, 1.8943F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-5.6197F, 12.9922F, 2.8943F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
	...
	public static LayerDefinition createBodyLayer(EquipmentSlot slot) {
		...
		if (slot.equals(EquipmentSlot.CHEST)) {
			...
			PartDefinition spike13 = body.addOrReplaceChild("spike13", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-1.2049F, -1.8333F, -0.5359F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-1.2049F, -1.3333F, 0.4641F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike16 = body.addOrReplaceChild("spike16", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-5.1717F, -1.8333F, -3.5797F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-5.1717F, -1.3333F, -2.5797F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike14 = body.addOrReplaceChild("spike14", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-1.2049F, 0.1667F, -0.5359F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-1.2049F, 0.6667F, 0.4641F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike17 = body.addOrReplaceChild("spike17", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-5.1717F, 0.1667F, -3.5797F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-5.1717F, 0.6667F, -2.5797F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition spike24 = body.addOrReplaceChild("spike24", CubeListBuilder.create().texOffs(13, 78)
					.addBox(-5.1717F, 0.1667F, -3.5797F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-5.1717F, 0.6667F, -2.5797F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(-6.1717F, 0.6667F, -3.5797F, 6.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
			...
			PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
					CubeListBuilder.create().texOffs(40, 16)
							...
							.addBox(-2.0F, -1.0F, 1.9F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 89)
			...
			PartDefinition spike3 = right_arm.addOrReplaceChild("spike3", CubeListBuilder.create().texOffs(13, 78)
					.addBox(0.1667F, -0.5F, -0.3333F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
					.addBox(0.1667F, 0.0F, 0.6667F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(13, 78)
			...
			PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
					CubeListBuilder.create().texOffs(42, 89)
							...
							.addBox(0.0F, -1.0F, 1.9F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 89)
		...
		if (slot.equals(EquipmentSlot.LEGS)) {
			...
			PartDefinition LeftLeg = left_leg.addOrReplaceChild("left_leg",
		...
		if (slot.equals(EquipmentSlot.FEET)) {
			...
			PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
					CubeListBuilder.create().texOffs(38, 91)
							...
							.addBox(-0.9F, 11.1F, -5.75F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 89)
							...
							.addBox(1.6F, 9.6F, -3.0F, 1.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 108)
			...
			PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
					CubeListBuilder.create().texOffs(40, 89)
							...
							.addBox(-2.6F, 9.6F, -3.0F, 1.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 108)
							...
							.addBox(-1.1F, 11.1F, -5.75F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(46, 123)
