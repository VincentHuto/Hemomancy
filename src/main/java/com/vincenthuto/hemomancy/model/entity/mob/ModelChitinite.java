...
public class ModelChitinite<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition plate4 = shell.addOrReplaceChild("plate4",
				...
				PartPose.offsetAndRotation(0.0F, -0.7637F, 2.3841F, -0.2182F, 0.0F, 0.0F));

		PartDefinition rLeg4 = plate4.addOrReplaceChild("rLeg4",
		...
		PartDefinition rLeg = plate4.addOrReplaceChild("rLeg",
		...
		PartDefinition lLeg5 = plate4.addOrReplaceChild("lLeg5",
		...
		PartDefinition lLeg4 = plate4.addOrReplaceChild("lLeg4",
		...
		PartDefinition plate5 = plate4.addOrReplaceChild("plate5",
				...
				PartPose.offsetAndRotation(0.0F, 0.5851F, 1.8947F, -0.3054F, 0.0F, 0.0F));

		PartDefinition plate3 = shell.addOrReplaceChild("plate3",
				...
				PartPose.offsetAndRotation(0.0F, 0.4226F, -0.0225F, -0.0436F, 0.0F, 0.0F));

		PartDefinition rLeg3 = plate3.addOrReplaceChild("rLeg3",
		...
		PartDefinition lLeg3 = plate3.addOrReplaceChild("lLeg3",
		...
		PartDefinition plate2 = shell.addOrReplaceChild("plate2",
				...
				PartPose.offsetAndRotation(0.0F, -0.7759F, -2.2109F, 0.1745F, 0.0F, 0.0F));

		PartDefinition lLeg2 = plate2.addOrReplaceChild("lLeg2",
		...
		PartDefinition rLeg5 = plate2.addOrReplaceChild("rLeg5",
		...
		PartDefinition rLeg2 = plate2.addOrReplaceChild("rLeg2",
		...
		PartDefinition lLeg = plate2.addOrReplaceChild("lLeg",
		...
		PartDefinition plate = plate2.addOrReplaceChild("plate",
				...
				PartPose.offsetAndRotation(-0.5F, 0.727F, -2.5342F, 0.3491F, 0.0F, 0.0F));
