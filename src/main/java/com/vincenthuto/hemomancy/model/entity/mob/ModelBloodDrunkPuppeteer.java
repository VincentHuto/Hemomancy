...
public class ModelBloodDrunkPuppeteer<T extends LivingEntity> extends HumanoidModel<T> {

	public static final Animation DANCE = new Animation.Builder(1.0F)
			.bone("body",
					new Animation.Bone.Builder(Easing.EASE_IN_OUT_CUBIC).rotation(0F, 0F, 0F, 15F)
							.rotation(0.5F, 0F, 0F, -15F).rotation(1.0F, 0F, 0F, 15F).build())
			.bone("head", new Animation.Bone.Builder(Easing.LINEAR).noRotation(0F).rotation(0.33F, 0F, 0F, -90F)
					.rotation(0.66F, 0F, 0F, 90F).noRotation(1.0F).build())
			.build();
	...
	public ModelBloodDrunkPuppeteer(ModelPart root) {
		super(root);
