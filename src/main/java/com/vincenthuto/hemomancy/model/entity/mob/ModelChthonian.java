...
public class ModelChthonian<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Hemomancy.MOD_ID, "modelchthonian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition abdomen = whole.addOrReplaceChild("abdomen", CubeListBuilder.create().texOffs(0, 17).addBox(-1.5F, -1.45F, 5.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 9).addBox(-2.0F, -2.35F, 2.0F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-2.5F, -3.25F, 0.0F, 5.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 0.0F, 7.5F));
		...
		.texOffs(13, 0).addBox(-0.5F, -1.0F, -4.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 0.0F, 0.0F));
		...
		PartDefinition rMandible = skull.addOrReplaceChild("rMandible", CubeListBuilder.create().texOffs(20, 21).addBox(-1.0F, -0.375F, -3.25F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(26, 30).addBox(-0.5F, -0.625F, -3.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 1.125F, -1.75F));

		PartDefinition lMandible = skull.addOrReplaceChild("lMandible", CubeListBuilder.create().texOffs(12, 21).addBox(0.0F, -0.45F, -2.75F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(6, 23).addBox(-0.5F, -0.7F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, 1.2F, -2.25F));
