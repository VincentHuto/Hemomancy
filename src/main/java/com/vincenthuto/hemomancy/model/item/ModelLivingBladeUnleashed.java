...
public class ModelLivingBladeUnleashed extends Model {
	...
	public static LayerDefinition createLayers() {
		...
		part.addOrReplaceChild("27",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5029F, -8.9441F, -2.0147F, 1.0F, 1.0F, 1.0F, false),
				PartPose.ZERO);
		part.addOrReplaceChild("28",
				CubeListBuilder.create().texOffs(6, 9).addBox(-0.0029F, -22.9441F, -1.0147F, 0.02F, 15.0F, 3.0F, false),
				PartPose.ZERO);
		part.addOrReplaceChild("29",
				CubeListBuilder.create().texOffs(0, 9).addBox(-0.0029F, -38.9441F, -1.5147F, 0.02F, 16.0F, 3.0F, false),
				PartPose.ZERO);
		part.addOrReplaceChild("30",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.0029F, -39.9441F, -0.5147F, 0.02F, 1.0F, 2.0F, false),
				PartPose.ZERO);
		part.addOrReplaceChild("31",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.0029F, -39.9441F, -0.5147F, 0.02F, 1.0F, 2.0F, false),
				PartPose.ZERO);
		part.addOrReplaceChild("32",
				CubeListBuilder.create().texOffs(12, 21).addBox(-0.0029F, -40.9441F, 1.4853F, 0.0F, 2.0F, 1.0F, false),
				PartPose.ZERO);
