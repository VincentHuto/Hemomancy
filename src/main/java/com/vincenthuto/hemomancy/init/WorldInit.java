...
//	public static ConfiguredStructureFeature<?, ?> CONFIGURED_BLOODTEMPLE = FeatureInit.blood_temple_structure.get()
//			.configured(new NoneFeatureConfiguration());
//	private static Method GETCODEC_METHOD;
//
//	public static void registerConfiguredStructures() {
//		Registry<ConfiguredStructureFeature<?, ?>> registry = BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE;
//		Registry.register(registry, new ResourceLocation(Hemomancy.MOD_ID, "blood_temple"), CONFIGURED_BLOODTEMPLE);
//	}
//
...
//					associateBiomeToConfiguredStructure(angelStructures, CONFIGURED_BLOODTEMPLE, biomeEntry.getKey());
//				}
//			}
//
...
//					.filter(entry -> !angelStructures.containsKey(entry.getKey()))
...
//					return;
//			} catch (Exception e) {
//				Hemomancy.LOGGER.error("Was unable to check if " + serverLevel.dimension().location()
...
//			}
//
//			Map<StructureFeature<?>, WorldGenSettingsFix.StructureFeatureConfiguration> tempMap = new HashMap<>(
//					worldStructureConfig.structureConfig());
//			tempMap.putIfAbsent(FeatureInit.blood_temple_structure.get(),
//					WorldgenSt.DEFAULTS.get(FeatureInit.blood_temple_structure.get()));
