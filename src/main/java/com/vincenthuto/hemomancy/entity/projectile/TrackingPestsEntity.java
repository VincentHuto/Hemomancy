...
public class TrackingPestsEntity extends ThrowableProjectile {
	...
	private static final EntityDataAccessor<Boolean> EVIL = SynchedEntityData.defineId(TrackingPestsEntity.class,
			EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Integer> TARGET = SynchedEntityData.defineId(TrackingPestsEntity.class,
			EntityDataSerializers.INT);

	double lockX, lockY = -1, lockZ;
	int time = 0;

	public TrackingPestsEntity(EntityType<TrackingPestsEntity> type, Level world) {
		super(type, world);
	}

	public TrackingPestsEntity(Level world) {
		this(TYPE, world);
	}

	public TrackingPestsEntity(LivingEntity thrower, boolean evil) {
