...
public class TrackingSerpentEntity extends ThrowableProjectile {
	...
	private static final EntityDataAccessor<Boolean> EVIL = SynchedEntityData.defineId(TrackingSerpentEntity.class,
			EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Integer> TARGET = SynchedEntityData.defineId(TrackingSerpentEntity.class,
			EntityDataSerializers.INT);

	double lockX, lockY = -1, lockZ;
	int time = 0;

	public TrackingSerpentEntity(EntityType<TrackingSerpentEntity> type, Level world) {
		super(type, world);
	}

	public TrackingSerpentEntity(Level world) {
		this(TYPE, world);
	}

	public TrackingSerpentEntity(LivingEntity thrower, boolean evil) {
