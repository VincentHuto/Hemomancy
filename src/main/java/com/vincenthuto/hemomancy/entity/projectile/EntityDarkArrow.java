...
public class EntityDarkArrow extends AbstractArrow {
	...
	public EntityDarkArrow(EntityType<? extends EntityDarkArrow> type, Level worldIn) {
		super(type, worldIn);
	}

	public EntityDarkArrow(Level worldIn, double x, double y, double z) {
		super(EntityInit.dark_arrow.get(), x, y, z, worldIn);
	}

	LivingEntity shooter;

	public EntityDarkArrow(Level worldIn, LivingEntity shooter) {
