...
public class EntityBloodBullet extends AbstractArrow {

	public EntityBloodBullet(EntityType<? extends EntityBloodBullet> type, Level worldIn) {
		super(type, worldIn);
	}

	public EntityBloodBullet(Level worldIn, double x, double y, double z) {
		super(EntityInit.blood_bullet.get(), x, y, z, worldIn);
	}

	public EntityBloodBullet(Level worldIn, LivingEntity shooter) {
