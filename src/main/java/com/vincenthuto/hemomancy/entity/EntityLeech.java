...
public class EntityLeech extends Animal {

	private static final EntityDataAccessor<Integer> SLUG_TYPE = SynchedEntityData.defineId(EntityLeech.class,
	...
	public EntityLeech(EntityType<? extends EntityLeech> type, Level worldIn) {
		super(type, worldIn);
	}
	 ...
	 */
	@Override
	public EntityLeech getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
