...
public class PotionInit {
	...
	public static final RegistryObject<Effect> blood_binding = EFFECTS.register("blood_binding",
			() -> new BloodBindingEffect(EffectType.HARMFUL, 3735555));
	...
	public static final RegistryObject<Effect> blood_loss = EFFECTS.register("blood_loss",
			() -> new BloodLossEffect(EffectType.HARMFUL, 11075587).addAttributesModifier(Attributes.MOVEMENT_SPEED,
