...
public class BlockEntityInit {
	...
	public static final RegistryObject<BlockEntityType<BlockEntityHumaneIdol>> humane_idol = TILES.register("humane_idol",
			() -> BlockEntityType.Builder.of(BlockEntityHumaneIdol::new, BlockInit.humane_idol.get()).build(null));
	public static final RegistryObject<BlockEntityType<BlockEntityMortalDisplay>> mortal_display = TILES.register(
			"mortal_display",
			() -> BlockEntityType.Builder.of(BlockEntityMortalDisplay::new, BlockInit.mortal_display.get()).build(null));
