...
public class EntityInit {
	...
	public static void registerAttributes(final FMLCommonSetupEvent event) {
		DefaultAttributes.put(EntityInit.leech.get(), EntityLeech.setAttributes().build());
		DefaultAttributes.put(EntityInit.fargone.get(), EntityFargone.setAttributes().build());
		DefaultAttributes.put(EntityInit.drudge.get(), EntityDrudge.setAttributes().build());
		DefaultAttributes.put(EntityInit.fungling.get(), EntityFungling.setAttributes().build());
		DefaultAttributes.put(EntityInit.thirster.get(), EntityThirster.setAttributes().build());
		DefaultAttributes.put(EntityInit.iron_pillar.get(), EntityIronPillar.setAttributes().build());
		DefaultAttributes.put(EntityInit.iron_wall.get(), EntityIronWall.setAttributes().build());
		DefaultAttributes.put(EntityInit.iron_spike.get(), EntityIronSpike.setAttributes().build());
		DefaultAttributes.put(EntityInit.blood_cloud.get(), EntityBloodCloud.setAttributes().build());
		DefaultAttributes.put(EntityInit.chitinite.get(), EntityChitinite.setAttributes().build());
		DefaultAttributes.put(EntityInit.chthonian.get(), EntityChthonian.setAttributes().build());
		DefaultAttributes.put(EntityInit.chthonian_queen.get(), EntityChthonianQueen.setAttributes().build());
		DefaultAttributes.put(EntityInit.lump_of_thought.get(), EntityLumpOfThought.setAttributes().build());
		DefaultAttributes.put(EntityInit.abhorent_thought.get(), EntityAbhorentThought.setAttributes().build());
		DefaultAttributes.put(EntityInit.morphling_polyp.get(), EntityMorphlingPolyp.setAttributes().build());
