...
public class PacketBloodCraftingKeyPressOld {
	...
	public PacketBloodCraftingKeyPressOld(ItemStack stack) {
		this.heldStack = stack;
	}

	public static PacketBloodCraftingKeyPressOld decode(final PacketBuffer buffer) {
		buffer.readByte();
		return new PacketBloodCraftingKeyPressOld(buffer.readItemStack());
	}

	public static void encode(final PacketBloodCraftingKeyPressOld message, final PacketBuffer buffer) {
		buffer.writeByte(0);
	...
	public static void handle(final PacketBloodCraftingKeyPressOld message, final Supplier<NetworkEvent.Context> ctx) {
		ctx.get().enqueueWork(() -> {
