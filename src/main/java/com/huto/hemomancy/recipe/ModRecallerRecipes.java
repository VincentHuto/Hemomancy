...
public class ModRecallerRecipes {
	...
	public static final RegistryObject<RecipeRecaller> recipeMetamorphosisCW = RECALLERRECIPES.register(
			"memory_blood_absorption",
			() -> registerRecallerRecipe(new ResourceLocation(Hemomancy.MOD_ID,"memory_blood_absorption"), new HashMap<EnumBloodTendency, Float>() {
				{
