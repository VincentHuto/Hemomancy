...
public class ModEntityPredicates {
	...
	public static Predicate<Entity> VORPAL = new Predicate<Entity>() {
		@Override
		public boolean test(Entity e) {
			if (e instanceof Raider || e instanceof Zombie || e instanceof Skeleton
					|| e instanceof WitherSkeleton || e instanceof Spider || e instanceof WitherBoss
					|| e instanceof Creeper || e instanceof Wolf || e instanceof AbstractPiglin
	...
	public static Predicate<Entity> COLDBLOODED = new Predicate<Entity>() {
		@Override
		public boolean test(Entity e) {
			if (e instanceof Raider || e instanceof Zombie || e instanceof WaterAnimal
	...
	public static Predicate<Entity> NOBLOOD = new Predicate<Entity>() {
		...
		public boolean test(Entity e) {
			if (e instanceof Skeleton || e instanceof WitherSkeleton || e instanceof IronGolem
					|| e instanceof WitherBoss || e instanceof SnowGolem || e instanceof Blaze
	...
	public static Predicate<Entity> ENDERBLOOD = new Predicate<Entity>() {
		@Override
		public boolean test(Entity e) {
			if (e instanceof EnderMan || e instanceof Endermite || e instanceof Endermite
					|| e instanceof EnderDragon || e instanceof Shulker || e instanceof Phantom) {
				return true;
			} else {
				return false;
			}
	...
	public static Predicate<Entity> INFERNALBLOOD = new Predicate<Entity>() {
		@Override
		public boolean test(Entity e) {
			if (e instanceof Blaze || e instanceof AbstractPiglin || e instanceof MagmaCube
					|| e instanceof Strider || e instanceof Ghast || e instanceof Hoglin
