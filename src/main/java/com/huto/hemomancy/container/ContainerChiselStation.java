...
public class ContainerChiselStation extends AbstractContainerMenu {
	...
	public ContainerChiselStation(final int windowId, final Inventory playerInv,
	...
	private static TileEntityChiselStation getTileEntity(final Inventory playerInv, final FriendlyByteBuf data) {
		Objects.requireNonNull(playerInv, "playerInventory cannot be null");
		Objects.requireNonNull(data, "data cannot be null");
		final BlockEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
