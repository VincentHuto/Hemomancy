...
public class ContainerVisceralRecaller extends Container {
	private final int numRows;
	private final TileEntityVisceralRecaller te;
	public int[] activatedRunes;

	public ContainerVisceralRecaller(final int windowId, final PlayerInventory playerInventory,
			final PacketBuffer data) {
		this(windowId, playerInventory, getTileEntity(playerInventory, data));
	}

	public ContainerVisceralRecaller(final int windowId, final PlayerInventory playerInv,
