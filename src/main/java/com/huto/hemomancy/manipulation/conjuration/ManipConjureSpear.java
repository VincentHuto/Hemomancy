...
public class ManipConjureSpear extends ManipBaseConjuration {

	public ManipConjureSpear(String name, double cost, double alignLevel, EnumManipulationRank rank,
