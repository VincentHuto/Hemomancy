...
public class ManipConjureBlade extends ManipBaseConjuration {

	public ManipConjureBlade(String name, double cost, double alignLevel, EnumManipulationRank rank,
	...
	@Override
	public Item getItem() {
		return ItemInit.living_blade.get();
	}
