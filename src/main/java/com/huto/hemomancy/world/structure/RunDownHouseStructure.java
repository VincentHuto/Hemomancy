...
public class RunDownHouseStructure extends StructureFeature<NoneFeatureConfiguration> {
	 ...
	 *
	 * Instead, use the LevelEvent.Load event in StructureTutorialMain class. If you
...
//    }
	...
	public static class Start extends StructureStart<NoneFeatureConfiguration> {
		...
		public void generatePieces(RegistryAccess dynamicRegistryManager, ChunkGenerator generator,
			...
			RunDownHousePieces.start(templateManagerIn, blockpos, rotation, this.pieces, this.random);
