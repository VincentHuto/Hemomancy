...
public class BlockCrimsonFlame extends Block {
	...
	public BlockCrimsonFlame(AbstractBlock.Properties builder, float fireDamageIn) {
		super(builder);
		...
		}).collect(Collectors.toMap(Function.identity(), BlockCrimsonFlame::getShapeForState)));
	}
	...
	public static void init() {
		BlockCrimsonFlame fireblock = (BlockCrimsonFlame) BlockInit.crimson_flames.get();
