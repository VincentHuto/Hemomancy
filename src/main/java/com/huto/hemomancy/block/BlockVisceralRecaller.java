...
public class BlockVisceralRecaller extends Block {
	...
	private static final VoxelShape SHAPE_N = Stream.of(
			Block.makeCuboidShape(1.5, 1.96, 3.25, 2.5, 2.96, 12.75),
			Block.makeCuboidShape(13.5, 6.9, 3, 14.5, 7.8, 12.75),
			Block.makeCuboidShape(13.5, 9, 3, 14.5, 9.8, 12.75),
			...
			Block.makeCuboidShape(13.5, 4, 3, 14.5, 5, 12.75),
			Block.makeCuboidShape(13.5, 1.96, 3, 14.5, 2.96, 12.75),
			Block.makeCuboidShape(1.5, 4, 3.25, 2.5, 5, 12.75),
			Block.makeCuboidShape(1.5, 6.9, 3.25, 2.5, 7.8, 12.75),
			Block.makeCuboidShape(1.5, 9, 3.25, 2.5, 9.8, 12.75),
			Block.makeCuboidShape(3.25, 6.9, 1.5, 12.75, 7.8, 2.5),
			Block.makeCuboidShape(3.25, 9, 1.5, 12.75, 9.8, 2.5),
			Block.makeCuboidShape(3.25, 4, 1.5, 12.75, 5, 2.5),
			...
			Block.makeCuboidShape(3.25, 9, 13.5, 12.75, 9.8, 14.5),
			Block.makeCuboidShape(2, 7, 2, 14, 11.002, 14),
			Block.makeCuboidShape(2.75, 10.752, 2.75, 13.25, 14.75, 13.25),
			Block.makeCuboidShape(1, 12.25, 1, 15, 14.25, 15),
			Block.makeCuboidShape(-1, 11.752, -1, 2, 14.754, 2),
			Block.makeCuboidShape(-1, 13.351, 2, 1, 15.351, 14),
			Block.makeCuboidShape(-1, 11.752, 14, 2, 14.754, 17),
			Block.makeCuboidShape(2, 13.351, 15, 14, 15.351, 17),
			Block.makeCuboidShape(14, 11.752, 14, 17, 14.754, 17),
			Block.makeCuboidShape(15, 13.351, 2, 17, 15.351, 14),
			Block.makeCuboidShape(14, 11.752, -1, 17, 14.754, 2),
			Block.makeCuboidShape(2, 13.351, -1, 14, 15.351, 1),
			Block.makeCuboidShape(0.5, 9.5, 0.5, 3.5, 12.5, 3.5),
