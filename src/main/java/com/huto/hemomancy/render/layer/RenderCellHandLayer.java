...
public class RenderCellHandLayer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
	public RenderCellHandLayer(IEntityRenderer<T, M> rendererIn) {
		super(rendererIn);
	}
