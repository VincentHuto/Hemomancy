...
public class RenderItemCellHand extends BlockEntityWithoutLevelRenderer {
	...
	@Override
	public void func_239207_a_(ItemStack stack, ItemTransforms.TransformType transformType,
	...
	private void renderDefaultItem(ItemStack stack, ItemTransforms.TransformType transformType,
			PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
		VertexConsumer buffers = buffer.getBuffer(Sheets.getCutoutBlockType());
		if (stack.getItem() instanceof ICellHand) {
