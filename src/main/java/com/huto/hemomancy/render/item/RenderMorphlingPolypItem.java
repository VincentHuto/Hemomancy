...
public class RenderMorphlingPolypItem extends EntityRenderer<ItemEntity> {
	private final net.minecraft.client.renderer.entity.ItemRenderer itemRenderer;
	private final Random random = new Random();

	public RenderMorphlingPolypItem(EntityRenderDispatcher renderManagerIn) {
	...
	public void render(ItemEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		IBakedModel ibakedmodel = this.itemRenderer.getItemModelWithOverrides(itemstack, entityIn.world,
				(LivingEntity) null);
