...
public class RenderBloodNeedle<T extends EntityBloodNeedle> extends EntityRenderer<EntityBloodNeedle> {
	...
	public RenderBloodNeedle(EntityRendererManager renderManagerIn) {
		super(renderManagerIn);
	}

	@SuppressWarnings("unused")
	public void render(EntityBloodNeedle entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
