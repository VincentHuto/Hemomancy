...
public class RenderIronSpike extends MobRenderer<EntityIronSpike, ModelIronSpike> {
	...
	public RenderIronSpike(EntityRenderDispatcher renderManagerIn) {
	...
	// Growth Scaling
	@Override
	protected void preRenderCallback(EntityIronSpike entitylivingbaseIn, PoseStack matrixStackIn,
