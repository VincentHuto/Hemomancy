...
public class RenderBloodBolt<T extends EntityBloodBolt> extends EntityRenderer<EntityBloodBolt> {
	...
	public RenderBloodBolt(EntityRendererManager renderManagerIn) {
		super(renderManagerIn);
	}

	@SuppressWarnings("unused")
	public void render(EntityBloodBolt entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
	...
	@Override
	public ResourceLocation getEntityTexture(EntityBloodBolt entity) {
		return TEXTURE;
	}
}
