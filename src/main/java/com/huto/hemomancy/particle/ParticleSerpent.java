...
@OnlyIn(Dist.CLIENT)
public class ParticleSerpent extends TextureSheetParticle {
	...
	public ParticleSerpent(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz, float r,
