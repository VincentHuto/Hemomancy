...
@OnlyIn(Dist.CLIENT)
public class ParticleHitGlow extends TextureSheetParticle {
	...
	public ParticleHitGlow(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz, float r,
