...
@OnlyIn(Dist.CLIENT)
public class ParticleBloodClaw extends SpriteTexturedParticle {
	...
	public ParticleBloodClaw(ClientWorld worldIn, double x, double y, double z, double vx, double vy, double vz,
