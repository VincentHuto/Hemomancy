...
public class CopyBloodGourdDataRecipe extends ShapedRecipe {
	...
	public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
			implements IRecipeSerializer<CopyBloodGourdDataRecipe> {
		@Nullable
		@Override
		public CopyBloodGourdDataRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
			return new CopyBloodGourdDataRecipe(IRecipeSerializer.CRAFTING_SHAPED.read(recipeId, buffer));
		}

		@Override
		public CopyBloodGourdDataRecipe read(ResourceLocation recipeId, JsonObject json) {
			try {
				return new CopyBloodGourdDataRecipe(IRecipeSerializer.CRAFTING_SHAPED.read(recipeId, json));
		...
		@Override
		public void write(PacketBuffer buffer, CopyBloodGourdDataRecipe recipe) {
			try {
