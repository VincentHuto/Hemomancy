...
import com.huto.hemomancy.util.BlockUtil;
...
public class DrudgeHarvestCropGoal extends BreakBlockGoal {
	public DrudgeHarvestCropGoal(CreatureEntity creatureIn, double speed, int yMax) {
