		...
		if (noActiveAnimation()) {
			if (distFromTarget > 15 && distFromTarget < 30) {
				...
				if (!level.isClientSide) {
					ParticleUtils.spawnPoof((ServerLevel) level, new BlockPos(Vector3.fromEntityCenter(this).x,
	...
	private class MoveTowardsTargetGoal extends Goal {
		...
		public boolean canUse() {
			...
			if (this.targetEntity == null) {
				...
				Vector3d vector3d = RandomPositionGenerator.getPosTowards(this.creature, 16, 7,
