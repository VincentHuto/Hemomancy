...
public class EntityChthonianQueen extends CreatureEntity implements IAnimatable {
	...
	public EntityChthonianQueen(EntityType<? extends EntityChthonianQueen> type, World worldIn) {
		super(type, worldIn);
