...
public class EntityTrackingPests extends ThrowableEntity {
	public static EntityType<EntityTrackingPests> TYPE = EntityInit.tracking_pests.get();

	private static final String TAG_TIME = "time";
	private static final DataParameter<Boolean> EVIL = EntityDataManager.createKey(EntityTrackingPests.class,
