...
public class EntityIronPillar extends CreatureEntity {
	...
	public void tick() {
		...
		if (this.ticksExisted < 2) {
			this.world.addParticle(ParticleTypes.SQUID_INK, this.getPosX() + (double) f, this.getPosY() + 2.0D + (double) f1,
	...
	protected void collideWithEntity(Entity entityIn) {
		...
		if (!(entityIn instanceof EntityIronPillar) && !(entityIn instanceof PlayerEntity) ) {
			entityIn.setMotion(0, 0.5f, 0);
