...
public class ModelChthonian extends AnimatedEntityModel<EntityChthonian> {
	...
	public ModelChthonian() {
		...
		abdomen.texOffs(0, 17).addBox(-1.5F, -1.45F, 5.0F, 3.0F, 4.0F, 2.0F, 0.0F, false);
		abdomen.texOffs(0, 9).addBox(-2.0F, -2.35F, 2.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		abdomen.texOffs(0, 0).addBox(-2.5F, -3.25F, 0.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);
		...
		rMandible.texOffs(20, 21).addBox(-1.0F, -0.375F, -3.25F, 1.0F, 1.0F, 3.0F, 0.0F, false);
		rMandible.texOffs(26, 30).addBox(-0.5F, -0.625F, -3.75F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		lMandible = new AnimatedModelRenderer(this);
		lMandible.setPos(1.5F, 1.2F, -2.25F);
		skull.addChild(lMandible);
		lMandible.texOffs(12, 21).addBox(0.0F, -0.45F, -2.75F, 1.0F, 1.0F, 3.0F, 0.0F, false);
		lMandible.texOffs(6, 23).addBox(-0.5F, -0.7F, -3.25F, 1.0F, 1.0F, 1.0F, 0.0F, false);
	...
	@Override
	public void setupAnim(EntityChthonian entity, float limbSwing, float limbSwingAmount, float ageInTicks,
