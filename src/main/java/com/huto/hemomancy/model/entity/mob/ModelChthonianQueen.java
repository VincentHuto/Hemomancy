...
public class ModelChthonianQueen extends AnimatedEntityModel<EntityChthonian> {
	...
	public ModelChthonianQueen() {
		...
		bone3.setRotationPoint(0.5F, 0.75F, 0.0F);
		abdomen.addChild(bone3);
		bone3.setTextureOffset(0, 9).addBox(-2.5F, -3.1F, 2.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		bone3.setTextureOffset(0, 0).addBox(-3.0F, -4.0F, 0.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);

		bone = new AnimatedModelRenderer(this);
		bone.setRotationPoint(0.0F, 0.0F, 5.0F);
		bone3.addChild(bone);
		bone.setTextureOffset(0, 9).addBox(-2.5F, -3.1F, 2.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		bone.setTextureOffset(0, 0).addBox(-3.0F, -4.0F, 0.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);

		bone2 = new AnimatedModelRenderer(this);
		bone2.setRotationPoint(-0.5F, -0.6F, 5.3333F);
		bone.addChild(bone2);
		bone2.setTextureOffset(0, 0).addBox(-2.5F, -3.4F, -0.3333F, 5.0F, 6.0F, 3.0F, 0.0F, false);
		bone2.setTextureOffset(0, 17).addBox(-1.5F, -1.6F, 3.6667F, 3.0F, 4.0F, 2.0F, 0.0F, false);
		bone2.setTextureOffset(0, 9).addBox(-2.0F, -2.5F, 1.6667F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		...
		skull.setTextureOffset(6, 21).addBox(-0.5F, -3.5F, -2.25F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		skull.setTextureOffset(13, 0).addBox(-0.5F, -1.0F, -4.5F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		skull.setTextureOffset(13, 0).addBox(-1.0F, -2.5F, -2.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		...
		rMandible.setTextureOffset(20, 21).addBox(-1.0F, -0.125F, -3.25F, 1.0F, 0.0F, 3.0F, 0.0F, false);
		rMandible.setTextureOffset(26, 30).addBox(-0.5F, -0.375F, -3.75F, 1.0F, 0.0F, 1.0F, 0.0F, false);

		lMandible = new AnimatedModelRenderer(this);
		lMandible.setRotationPoint(1.5F, 1.2F, -2.25F);
		skull.addChild(lMandible);
		lMandible.setTextureOffset(12, 21).addBox(0.0F, -0.2F, -2.75F, 1.0F, 0.0F, 3.0F, 0.0F, false);
		lMandible.setTextureOffset(6, 23).addBox(-0.5F, -0.45F, -3.25F, 1.0F, 0.0F, 1.0F, 0.0F, false);
