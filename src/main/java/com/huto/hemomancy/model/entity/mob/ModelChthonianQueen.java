...
public class ModelChthonianQueen extends AnimatedEntityModel<EntityChthonianQueen> {
	...
	public ModelChthonianQueen() {
		texWidth = 64;
		texHeight = 64;

		whole = new AnimatedModelRenderer(this);
		whole.setPos(0.5F, 19.5F, -4.0F);

		abdomen = new AnimatedModelRenderer(this);
		abdomen.setPos(-0.5F, 0.0F, 7.5F);
		whole.addChild(abdomen);

		bone3 = new AnimatedModelRenderer(this);
		bone3.setPos(0.5F, 0.75F, 0.0F);
		abdomen.addChild(bone3);
		bone3.texOffs(0, 9).addBox(-2.5F, -3.1F, 2.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		bone3.texOffs(0, 0).addBox(-3.0F, -4.0F, 0.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);

		bone = new AnimatedModelRenderer(this);
		bone.setPos(0.0F, 0.0F, 5.0F);
		bone3.addChild(bone);
		bone.texOffs(0, 9).addBox(-2.5F, -3.1F, 2.0F, 4.0F, 5.0F, 3.0F, 0.0F, false);
		bone.texOffs(0, 0).addBox(-3.0F, -4.0F, 0.0F, 5.0F, 6.0F, 3.0F, 0.0F, false);

		bone2 = new AnimatedModelRenderer(this);
		bone2.setPos(-0.5F, -0.6F, 5.3333F);
		bone.addChild(bone2);
		bone2.texOffs(0, 0).addBox(-2.5F, -3.4F, -0.3333F, 5.0F, 6.0F, 3.0F, 0.0F, false);
		bone2.texOffs(0, 17).addBox(-1.5F, -1.6F, 3.6667F, 3.0F, 4.0F, 2.0F, 0.0F, false);
		bone2.texOffs(0, 9).addBox(-2.0F, -2.5F, 1.6667F, 4.0F, 5.0F, 3.0F, 0.0F, false);

		thorax = new AnimatedModelRenderer(this);
		thorax.setPos(0.0F, 0.0F, 2.0F);
		whole.addChild(thorax);
		thorax.texOffs(11, 14).addBox(-2.5F, -2.25F, -1.5F, 4.0F, 4.0F, 3.0F, 0.0F, false);
		thorax.texOffs(14, 25).addBox(-1.5F, -2.75F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(22, 6).addBox(-1.5F, 1.25F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(13, 6).addBox(-2.0F, -1.5F, 2.0F, 3.0F, 3.0F, 3.0F, 0.0F, false);
		thorax.texOffs(0, 24).addBox(-1.5F, -2.0F, 2.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(22, 12).addBox(-1.5F, 1.0F, 2.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(17, 29).addBox(-1.0F, -0.25F, -2.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(0, 29).addBox(-1.0F, -0.25F, 1.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		thorax.texOffs(28, 3).addBox(-1.0F, -0.25F, 4.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		rLegs = new AnimatedModelRenderer(this);
		rLegs.setPos(-2.0F, -1.0F, 2.0F);
		thorax.addChild(rLegs);

		rFrontLeg = new AnimatedModelRenderer(this);
		rFrontLeg.setPos(-0.25F, 0.5F, -2.5F);
		rLegs.addChild(rFrontLeg);
		setRotationAngle(rFrontLeg, 0.0F, 0.0F, 0.2618F);
		rFrontLeg.texOffs(28, 12).addBox(-1.5559F, 0.2244F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		rFrontLeg2 = new AnimatedModelRenderer(this);
		rFrontLeg2.setPos(-1.75F, 0.0F, 0.0F);
		rFrontLeg.addChild(rFrontLeg2);
		setRotationAngle(rFrontLeg2, 0.0F, 0.0F, -0.7854F);
		rFrontLeg2.texOffs(25, 17).addBox(-3.375F, 0.1495F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rFrontLeg3 = new AnimatedModelRenderer(this);
		rFrontLeg3.setPos(-3.0F, 0.0F, 0.0F);
		rFrontLeg2.addChild(rFrontLeg3);
		setRotationAngle(rFrontLeg3, 0.0F, -0.48F, 0.0F);
		rFrontLeg3.texOffs(25, 9).addBox(-3.3326F, 0.1495F, -0.3268F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rFrontLeg4 = new AnimatedModelRenderer(this);
		rFrontLeg4.setPos(-3.0F, 0.0F, 0.0F);
		rFrontLeg3.addChild(rFrontLeg4);
		rFrontLeg4.texOffs(0, 23).addBox(-3.3471F, 1.1634F, -0.4564F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		rMidLeg = new AnimatedModelRenderer(this);
		rMidLeg.setPos(-0.25F, 0.5F, -0.5F);
		rLegs.addChild(rMidLeg);
		setRotationAngle(rMidLeg, 0.0F, 0.0F, 0.2618F);
		rMidLeg.texOffs(28, 6).addBox(-1.75F, 0.25F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		rMidLeg2 = new AnimatedModelRenderer(this);
		rMidLeg2.setPos(-1.75F, 0.0F, 0.0F);
		rMidLeg.addChild(rMidLeg2);
		setRotationAngle(rMidLeg2, 0.0F, 0.0F, -0.7854F);
		rMidLeg2.texOffs(25, 0).addBox(-3.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rMidLeg3 = new AnimatedModelRenderer(this);
		rMidLeg3.setPos(-3.0F, 0.0F, 0.0F);
		rMidLeg2.addChild(rMidLeg3);
		setRotationAngle(rMidLeg3, 0.0F, -0.0873F, 0.0F);
		rMidLeg3.texOffs(20, 25).addBox(-3.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rMidLeg4 = new AnimatedModelRenderer(this);
		rMidLeg4.setPos(-3.0F, 0.0F, 0.0F);
		rMidLeg3.addChild(rMidLeg4);
		rMidLeg4.texOffs(16, 22).addBox(-3.0F, 1.25F, -0.5F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		rBackLeg = new AnimatedModelRenderer(this);
		rBackLeg.setPos(-0.25F, 0.5F, 2.25F);
		rLegs.addChild(rBackLeg);
		setRotationAngle(rBackLeg, 0.0F, 0.0F, 0.2618F);
		rBackLeg.texOffs(7, 26).addBox(-1.75F, 0.25F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		rBackLeg2 = new AnimatedModelRenderer(this);
		rBackLeg2.setPos(-1.75F, 0.0F, 0.0F);
		rBackLeg.addChild(rBackLeg2);
		setRotationAngle(rBackLeg2, 0.0F, 0.0F, -0.7854F);
		rBackLeg2.texOffs(22, 15).addBox(-3.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rBackLeg3 = new AnimatedModelRenderer(this);
		rBackLeg3.setPos(-3.0F, 0.0F, 0.0F);
		rBackLeg2.addChild(rBackLeg3);
		setRotationAngle(rBackLeg3, 0.0F, 0.2618F, 0.0F);
		rBackLeg3.texOffs(14, 12).addBox(-3.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		rBackLeg4 = new AnimatedModelRenderer(this);
		rBackLeg4.setPos(-3.0F, 0.0F, 0.0F);
		rBackLeg3.addChild(rBackLeg4);
		rBackLeg4.texOffs(16, 21).addBox(-3.0F, 1.25F, -0.5F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		lLegs = new AnimatedModelRenderer(this);
		lLegs.setPos(1.5F, -1.0F, 2.0F);
		thorax.addChild(lLegs);

		lFrontLeg = new AnimatedModelRenderer(this);
		lFrontLeg.setPos(-0.5F, 0.5F, -2.45F);
		lLegs.addChild(lFrontLeg);
		setRotationAngle(lFrontLeg, 0.0F, 0.0F, -0.2618F);
		lFrontLeg.texOffs(21, 29).addBox(-0.1941F, 0.2244F, -0.55F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		lFrontLeg2 = new AnimatedModelRenderer(this);
		lFrontLeg2.setPos(2.0F, 0.0F, -0.05F);
		lFrontLeg.addChild(lFrontLeg2);
		setRotationAngle(lFrontLeg2, 0.0F, 0.0F, 0.7854F);
		lFrontLeg2.texOffs(25, 21).addBox(0.375F, 0.1495F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lFrontLeg3 = new AnimatedModelRenderer(this);
		lFrontLeg3.setPos(3.0F, 0.0F, 0.0F);
		lFrontLeg2.addChild(lFrontLeg3);
		setRotationAngle(lFrontLeg3, 0.0F, 0.48F, 0.0F);
		lFrontLeg3.texOffs(25, 19).addBox(0.3326F, 0.1495F, -0.3268F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lFrontLeg4 = new AnimatedModelRenderer(this);
		lFrontLeg4.setPos(3.0F, 0.0F, 0.0F);
		lFrontLeg3.addChild(lFrontLeg4);
		lFrontLeg4.texOffs(16, 23).addBox(0.3471F, 1.1634F, -0.4564F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		lMidLeg = new AnimatedModelRenderer(this);
		lMidLeg.setPos(-0.5F, 0.5F, -0.45F);
		lLegs.addChild(lMidLeg);
		setRotationAngle(lMidLeg, 0.0F, 0.0F, -0.2618F);
		lMidLeg.texOffs(29, 14).addBox(0.0F, 0.25F, -0.55F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		lMidLeg2 = new AnimatedModelRenderer(this);
		lMidLeg2.setPos(2.0F, 0.0F, -0.05F);
		lMidLeg.addChild(lMidLeg2);
		setRotationAngle(lMidLeg2, 0.0F, 0.0F, 0.7854F);
		lMidLeg2.texOffs(21, 27).addBox(0.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lMidLeg3 = new AnimatedModelRenderer(this);
		lMidLeg3.setPos(3.0F, 0.0F, 0.0F);
		lMidLeg2.addChild(lMidLeg3);
		setRotationAngle(lMidLeg3, 0.0F, 0.0873F, 0.0F);
		lMidLeg3.texOffs(0, 27).addBox(0.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lMidLeg4 = new AnimatedModelRenderer(this);
		lMidLeg4.setPos(3.0F, 0.0F, 0.0F);
		lMidLeg3.addChild(lMidLeg4);
		lMidLeg4.texOffs(24, 2).addBox(0.0F, 1.25F, -0.5F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		lBackLeg = new AnimatedModelRenderer(this);
		lBackLeg.setPos(-0.5F, 0.5F, 2.3F);
		lLegs.addChild(lBackLeg);
		setRotationAngle(lBackLeg, 0.0F, 0.0F, -0.2618F);
		lBackLeg.texOffs(6, 30).addBox(0.0F, 0.25F, -0.55F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		lBackLeg2 = new AnimatedModelRenderer(this);
		lBackLeg2.setPos(2.0F, 0.0F, -0.05F);
		lBackLeg.addChild(lBackLeg2);
		setRotationAngle(lBackLeg2, 0.0F, 0.0F, 0.7854F);
		lBackLeg2.texOffs(7, 28).addBox(0.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lBackLeg3 = new AnimatedModelRenderer(this);
		lBackLeg3.setPos(3.0F, 0.0F, 0.0F);
		lBackLeg2.addChild(lBackLeg3);
		setRotationAngle(lBackLeg3, 0.0F, -0.2618F, 0.0F);
		lBackLeg3.texOffs(27, 24).addBox(0.0F, 0.25F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		lBackLeg4 = new AnimatedModelRenderer(this);
		lBackLeg4.setPos(3.0F, 0.0F, 0.0F);
		lBackLeg3.addChild(lBackLeg4);
		lBackLeg4.texOffs(24, 11).addBox(0.0F, 1.25F, -0.5F, 3.0F, 0.0F, 1.0F, 0.0F, false);

		skull = new AnimatedModelRenderer(this);
		skull.setPos(-0.5F, 0.0F, 0.0F);
		whole.addChild(skull);
		skull.texOffs(16, 0).addBox(-1.5F, -1.25F, -3.0F, 3.0F, 3.0F, 3.0F, 0.0F, false);
		skull.texOffs(6, 21).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		skull.texOffs(6, 21).addBox(-0.5F, -3.5F, -2.25F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		skull.texOffs(13, 0).addBox(-0.5F, -1.0F, -4.5F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		skull.texOffs(13, 0).addBox(-1.0F, -2.5F, -2.5F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		lEye = new AnimatedModelRenderer(this);
		lEye.setPos(1.5F, -1.0F, -1.5F);
		skull.addChild(lEye);
		setRotationAngle(lEye, 0.3054F, 0.0F, 0.0F);
		lEye.texOffs(13, 28).addBox(-0.5F, 0.2153F, -1.2255F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		rEye = new AnimatedModelRenderer(this);
		rEye.setPos(-1.5F, -1.0F, -1.5F);
		skull.addChild(rEye);
		setRotationAngle(rEye, 0.3054F, 0.0F, 0.0F);
		rEye.texOffs(27, 27).addBox(-0.5F, 0.2153F, -1.2255F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		rMandible = new AnimatedModelRenderer(this);
		rMandible.setPos(-1.5F, 1.125F, -1.75F);
		skull.addChild(rMandible);
		rMandible.texOffs(20, 21).addBox(-1.0F, -0.125F, -3.25F, 1.0F, 0.0F, 3.0F, 0.0F, false);
		rMandible.texOffs(26, 30).addBox(-0.5F, -0.375F, -3.75F, 1.0F, 0.0F, 1.0F, 0.0F, false);

		lMandible = new AnimatedModelRenderer(this);
		lMandible.setPos(1.5F, 1.2F, -2.25F);
		skull.addChild(lMandible);
		lMandible.texOffs(12, 21).addBox(0.0F, -0.2F, -2.75F, 1.0F, 0.0F, 3.0F, 0.0F, false);
		lMandible.texOffs(6, 23).addBox(-0.5F, -0.45F, -3.25F, 1.0F, 0.0F, 1.0F, 0.0F, false);
	...
	@Override
	public void setupAnim(EntityChthonianQueen entity, float limbSwing, float limbSwingAmount, float ageInTicks,
