...
public class GuiMorphlingJar extends ContainerScreen<ContainerMorphlingJar> {
	public GuiMorphlingJar(ContainerMorphlingJar container, PlayerInventory playerInventory, ITextComponent name) {
