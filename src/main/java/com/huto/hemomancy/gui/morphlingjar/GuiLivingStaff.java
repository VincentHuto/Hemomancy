...
public class GuiLivingStaff extends ContainerScreen<ContainerLivingStaff> {
	public GuiLivingStaff(ContainerLivingStaff container, PlayerInventory playerInventory, ITextComponent name) {
