...
public class TendencyBookLib {
	...
	public static void registerPages() {
		...
		AnimusPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.ANIMUS, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_1)));
		AnimusPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.ANIMUS, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_2)));
		AnimusPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.ANIMUS, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_3)));
		AnimusPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.ANIMUS, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_4)));
		AnimusPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.ANIMUS, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_5)));
		AnimusPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.ANIMUS, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_6)));
		AnimusPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.ANIMUS, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(ANIMUS_PAGE_7)));

		// Mortem
		MortemPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.MORTEM, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_1)));
		MortemPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.MORTEM, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_2)));
		MortemPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.MORTEM, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_3)));
		MortemPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.MORTEM, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_4)));
		MortemPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.MORTEM, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_5)));
		MortemPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.MORTEM, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_6)));
		MortemPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.MORTEM, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(MORTEM_PAGE_7)));

		// Ductilis
		DuctilisPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.DUCTILIS, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_1)));
		DuctilisPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.DUCTILIS, "Duality of Nature",
				"Yin and Yang", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_2)));
		DuctilisPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.DUCTILIS, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_3)));
		DuctilisPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.DUCTILIS, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_4)));
		DuctilisPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.DUCTILIS, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_5)));
		DuctilisPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.DUCTILIS, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_6)));
		DuctilisPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.DUCTILIS, "Vital Essence",
				"The Power of Vitals", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(DUCTILIS_PAGE_7)));

		// Ferric
		FerricPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.FERRIC, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_1)));
		FerricPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.FERRIC, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_2)));
		FerricPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.FERRIC, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_3)));
		FerricPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.FERRIC, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_4)));
		FerricPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.FERRIC, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_5)));
		FerricPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.FERRIC, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_6)));
		FerricPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.FERRIC, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FERRIC_PAGE_7)));

		// Lux
		LuxPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.LUX, "In the Begining", "It Started Somewhere",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_1)));
		LuxPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.LUX, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_2)));
		LuxPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.LUX, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_3)));
		LuxPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.LUX, "A Level of Essence", "Only the Essentials",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_4)));
		LuxPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.LUX, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_5)));
		LuxPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.LUX, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_6)));
		LuxPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.LUX, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(LUX_PAGE_7)));
		// Tenebris
		TenebrisPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.TENEBRIS, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_1)));
		TenebrisPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.TENEBRIS, "Duality of Nature",
				"Yin and Yang", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_2)));
		TenebrisPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.TENEBRIS, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_3)));
		TenebrisPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.TENEBRIS, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_4)));
		TenebrisPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.TENEBRIS, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_5)));
		TenebrisPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.TENEBRIS, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_6)));
		TenebrisPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.TENEBRIS, "Vital Essence",
				"The Power of Vitals", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(TENEBRIS_PAGE_7)));

		// Flammeus
		FlammeusPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.FLAMMEUS, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_1)));
		FlammeusPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.FLAMMEUS, "Duality of Nature",
				"Yin and Yang", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_2)));
		FlammeusPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.FLAMMEUS, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_3)));
		FlammeusPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.FLAMMEUS, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_4)));
		FlammeusPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.FLAMMEUS, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_5)));
		FlammeusPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.FLAMMEUS, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_6)));
		FlammeusPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.FLAMMEUS, "Vital Essence",
				"The Power of Vitals", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(FLAMMEUS_PAGE_7)));
		// Congeatio
		CongeatioPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.CONGEATIO, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_1)));
		CongeatioPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.CONGEATIO, "Duality of Nature",
				"Yin and Yang", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_2)));
		CongeatioPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.CONGEATIO, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_3)));
		CongeatioPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.CONGEATIO, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_4)));
		CongeatioPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.CONGEATIO, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_5)));
		CongeatioPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.CONGEATIO, "Nullification",
				"Counter Attack", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_6)));
		CongeatioPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.CONGEATIO, "Vital Essence",
				"The Power of Vitals", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(CONGEATIO_PAGE_7)));

		// Hidden
		HiddenPageList.add(new GuiTendencyPage(1, EnumTendencyCatagories.HIDDEN, "In the Begining",
				"It Started Somewhere", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_1)));
		HiddenPageList.add(new GuiTendencyPage(2, EnumTendencyCatagories.HIDDEN, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_2)));
		HiddenPageList.add(new GuiTendencyPage(3, EnumTendencyCatagories.HIDDEN, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_3)));
		HiddenPageList.add(new GuiTendencyPage(4, EnumTendencyCatagories.HIDDEN, "A Level of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_4)));
		HiddenPageList.add(new GuiTendencyPage(5, EnumTendencyCatagories.HIDDEN, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_5)));
		HiddenPageList.add(new GuiTendencyPage(6, EnumTendencyCatagories.HIDDEN, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_6)));
		HiddenPageList.add(new GuiTendencyPage(7, EnumTendencyCatagories.HIDDEN, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.get(HIDDEN_PAGE_7)));
