...
@OnlyIn(Dist.CLIENT)
public class GuiTomeImage extends AbstractWidget {
	...
	public GuiTomeImage(ResourceLocation texIn, int idIn, int zoneIn, int posXIn, int posYIn, int buttonWidthIn,
			int buttonHeightIn, int uIn, int vIn, List<Component> textIn, float scaleIn) {
		super(posXIn, posYIn, buttonHeightIn, buttonWidthIn, new TextComponent(""));
		this.texture = texIn;
		this.id = idIn;
		this.zone = zoneIn;
	...
	public GuiTomeImage(ResourceLocation texIn, int idIn, int zoneIn) {
		super(0, 0, 54, 54, new TextComponent(""));
		this.texture = texIn;
		this.id = idIn;
		this.zone = zoneIn;
		this.x = getZoneX(zoneIn);
	...
	public GuiTomeImage(ResourceLocation texIn, int idIn, int zoneIn, List<Component> textIn) {
		super(0, 0, 54, 54, new TextComponent(""));
		this.texture = texIn;
		this.id = idIn;
		this.zone = zoneIn;
	...
	public GuiTomeImage(ResourceLocation texIn, int idIn, int zoneIn, int buttonWidthIn, int buttonHeightIn) {
		super(0, 0, buttonHeightIn, buttonWidthIn, new TextComponent(""));
		this.texture = texIn;
		this.id = idIn;
		this.zone = zoneIn;
		this.x = getZoneX(zoneIn);
	...
	public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks, int centerXIn,
			int centerYIn) {
