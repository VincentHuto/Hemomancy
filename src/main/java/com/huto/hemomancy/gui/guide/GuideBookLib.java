...
public class GuideBookLib {
	...
	public static void registerPages() {
		...
		IntroPageList.add(new GuiGuidePage(1, EnumTomeCatagories.INTRO, "In the Begining", "It Started Somewhere",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_1)));
		IntroPageList.add(new GuiGuidePage(2, EnumTomeCatagories.INTRO, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_2)));
		IntroPageList.add(new GuiGuidePage(3, EnumTomeCatagories.INTRO, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_3)));
		IntroPageList.add(new GuiGuidePage(4, EnumTomeCatagories.INTRO, "A World of Essence", "Only the Essentials",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_4)));
		IntroPageList.add(new GuiGuidePage(5, EnumTomeCatagories.INTRO, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_5)));
		IntroPageList.add(new GuiGuidePage(6, EnumTomeCatagories.INTRO, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_6)));
		IntroPageList.add(new GuiGuidePage(7, EnumTomeCatagories.INTRO, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(INTRO_PAGE_7)));
		...
		// Vascular
		VascularPageList
				.add(new GuiGuidePage(1, EnumTomeCatagories.VASCULARSYSTEM, "In the Begining", "It Started Somewhere",
						new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_1)));
		VascularPageList.add(new GuiGuidePage(2, EnumTomeCatagories.VASCULARSYSTEM, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_2)));
		VascularPageList.add(new GuiGuidePage(3, EnumTomeCatagories.VASCULARSYSTEM, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_3)));
		VascularPageList.add(new GuiGuidePage(4, EnumTomeCatagories.VASCULARSYSTEM, "A World of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_4)));
		VascularPageList.add(new GuiGuidePage(5, EnumTomeCatagories.VASCULARSYSTEM, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_5)));
		VascularPageList.add(new GuiGuidePage(6, EnumTomeCatagories.VASCULARSYSTEM, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_6)));
		VascularPageList.add(new GuiGuidePage(7, EnumTomeCatagories.VASCULARSYSTEM, "Vital Essence",
				"The Power of Vitals", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(VASCULAR_PAGE_7)));
		...
		TendencyPageList.add(new GuiGuidePage(1, EnumTomeCatagories.TENDENCY, "In the Begining", "It Started Somewhere",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_1)));
		TendencyPageList.add(new GuiGuidePage(2, EnumTomeCatagories.TENDENCY, "Duality of Nature", "Yin and Yang",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_2)));
		TendencyPageList.add(new GuiGuidePage(3, EnumTomeCatagories.TENDENCY, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_3)));
		TendencyPageList.add(new GuiGuidePage(4, EnumTomeCatagories.TENDENCY, "A World of Essence",
				"Only the Essentials", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_4)));
		TendencyPageList.add(new GuiGuidePage(5, EnumTomeCatagories.TENDENCY, "Channeling Basics", "Use the Force",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_5)));
		TendencyPageList.add(new GuiGuidePage(6, EnumTomeCatagories.TENDENCY, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_6)));
		TendencyPageList.add(new GuiGuidePage(7, EnumTomeCatagories.TENDENCY, "Vital Essence", "The Power of Vitals",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(TENDENCY_PAGE_7)));
		...
		ManipulationPageList
				.add(new GuiGuidePage(1, EnumTomeCatagories.MANIPULATION, "In the Begining", "It Started Somewhere",
						new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_1)));
		ManipulationPageList.add(new GuiGuidePage(2, EnumTomeCatagories.MANIPULATION, "Duality of Nature",
				"Yin and Yang", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_2)));
		ManipulationPageList.add(new GuiGuidePage(3, EnumTomeCatagories.MANIPULATION, "Vibes", "Cosmic Vibrations",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_3)));
		ManipulationPageList
				.add(new GuiGuidePage(4, EnumTomeCatagories.MANIPULATION, "A World of Essence", "Only the Essentials",
						new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_4)));
		ManipulationPageList.add(new GuiGuidePage(5, EnumTomeCatagories.MANIPULATION, "Channeling Basics",
				"Use the Force", new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_5)));
		ManipulationPageList.add(new GuiGuidePage(6, EnumTomeCatagories.MANIPULATION, "Nullification", "Counter Attack",
				new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_6)));
		ManipulationPageList
				.add(new GuiGuidePage(7, EnumTomeCatagories.MANIPULATION, "Vital Essence", "The Power of Vitals",
						new ItemStack(ItemInit.sanguine_formation.get()), I18n.format(MANIPULATION_PAGE_7)));
