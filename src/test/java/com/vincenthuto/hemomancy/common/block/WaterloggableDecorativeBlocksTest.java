...
public final class WaterloggableDecorativeBlocksTest {
	...
	private static final TargetBlock[] TARGETS = {
			new TargetBlock("suspended_blood_crystal",
					"com/vincenthuto/hemomancy/common/block/harbinger/rite/SuspendedBloodCrystalBlock.java"),
			...
			new TargetBlock("suspended_vivianite",
					"com/vincenthuto/hemomancy/common/block/harbinger/rite/SuspendedVivianiteBlock.java"),
			...
			new TargetBlock("blood_crystal",
					"com/vincenthuto/hemomancy/common/block/harbinger/rite/BloodCrystalBlock.java"),
			...
			new TargetBlock("humane_idol",
					"com/vincenthuto/hemomancy/common/block/harbinger/decoration/BlockHumaneIdol.java"),
			new TargetBlock("serpentine_idol",
					"com/vincenthuto/hemomancy/common/block/harbinger/decoration/BlockSerpentineIdol.java"),
			...
			new TargetBlock("mycelial_crucible",
					"com/vincenthuto/hemomancy/common/block/harbinger/crafting/MycelialCrucibleBlock.java"),
