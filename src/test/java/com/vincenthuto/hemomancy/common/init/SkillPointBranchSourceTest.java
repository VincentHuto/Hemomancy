...
public final class SkillPointBranchSourceTest {
	...
	public static void main(String[] args) throws IOException {
		...
		assertContains("skills tab keeps locked branch-colored nodes readable", skillsTab, "withAlpha(branchColor, 0xAA)");
		...
		assertContains("skills tab keeps degree-locked branch outlines colored", skillsTab, "withAlpha(branchColor, 0xCC)");
		...
		assertContains("core branch reaches north on degree five", core, "setTreePosition(537, 80)");
