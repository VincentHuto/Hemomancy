...
> **2026-05-04 Specimen Jar Update:** `SpecimenJarBlockItem`, `SpecimenJarBlock`, and `SpecimenJarBlockEntity` add Hemomancy-only arthropod capture/display/release using the `hemomancy:specimen_jar_capturable` entity type tag. Placed jars now store horizontal facing and rotate the displayed specimen toward the placer.
